...
`;let _i=class extends le{constructor(){super(...arguments),this.turns=[],this.timer=0,this.inGame=!1,this.timeElapsed="00m 00s",this.gameSummary=[],this.hasMatch=!1,this.pairs=[],this.choices=[],this.cards=[],this.unsubTimer=()=>0}static get styles(){return ge`
    ...
    `}handleEnter(e){const{clientX:i,clientY:t}=e,s=this.shadowRoot.querySelector(".tooltip");let a=0;if(s&&s.firstChild){const e=s.getBoundingClientRect(),i=s.firstChild.offsetWidth,t=window.innerWidth-(e.width+e.left);i>e.left+e.width/2?a=-e.left:t<i&&(a=-(i-t))}clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.isHovered=!0,this.at=[i,t,a]},this.delay)}handleLeave(){clearTimeout(this.timer),this.isHovered=!1,this.at=[]}};Di([ne({type:String})],Ei.prototype,"text",void 0),Di([ne({type:Number})],Ei.prototype,"delay",void 0),Di([ne({type:Boolean})],Ei.prototype,"allowWrapping",void 0),Di([ne({type:Boolean})],Ei.prototype,"usePosition",void 0),Di([ne({type:Number})],Ei.prototype,"timer",void 0),Di([ne({type:Boolean})],Ei.prototype,"isHovered",void 0),Di([ne({type:Array})],Ei.prototype,"at",void 0),Ei=Di([ae("glk-tooltip")],Ei);let zi=class extends le{static get styles(){return ge`
      :host,
      main {
    ...
    `}};zi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o}([ae("glk-app")],zi)}]);