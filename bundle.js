 ...
 */
const s=new WeakMap,a=e=>"function"==typeof e&&s.has(e),r=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,o=(e,i,t=null,s=null)=>{for(;i!==t;){const t=i.nextSibling;e.insertBefore(i,s),i=t}},n=(e,i,t=null)=>{for(;i!==t;){const t=i.nextSibling;e.removeChild(i),i=t}},m={},d={},c=`{{lit-${String(Math.random()).slice(2)}}}`,g=`\x3c!--${c}--\x3e`,u=new RegExp(`${c}|${g}`),l="$lit$";class p{constructor(e,i){this.parts=[],this.element=i;const t=[],s=[],a=document.createTreeWalker(i.content,133,null,!1);let r=0,o=-1,n=0;const{strings:m,values:{length:d}}=e;for(;n<d;){const e=a.nextNode();if(null!==e){if(o++,1===e.nodeType){if(e.hasAttributes()){const i=e.attributes,{length:t}=i;let s=0;for(let e=0;e<t;e++)h(i[e].name,l)&&s++;for(;s-- >0;){const i=m[n],t=k.exec(i)[2],s=t.toLowerCase()+l,a=e.getAttribute(s);e.removeAttribute(s);const r=a.split(u);this.parts.push({type:"attribute",index:o,name:t,strings:r}),n+=r.length-1}}"TEMPLATE"===e.tagName&&(s.push(e),a.currentNode=e.content)}else if(3===e.nodeType){const i=e.data;if(i.indexOf(c)>=0){const s=e.parentNode,a=i.split(u),r=a.length-1;for(let i=0;i<r;i++){let t,r=a[i];if(""===r)t=y();else{const e=k.exec(r);null!==e&&h(e[2],l)&&(r=r.slice(0,e.index)+e[1]+e[2].slice(0,-l.length)+e[3]),t=document.createTextNode(r)}s.insertBefore(t,e),this.parts.push({type:"node",index:++o})}""===a[r]?(s.insertBefore(y(),e),t.push(e)):e.data=a[r],n+=r}}else if(8===e.nodeType)if(e.data===c){const i=e.parentNode;null!==e.previousSibling&&o!==r||(o++,i.insertBefore(y(),e)),r=o,this.parts.push({type:"node",index:o}),null===e.nextSibling?e.data="":(t.push(e),o--),n++}else{let i=-1;for(;-1!==(i=e.data.indexOf(c,i+1));)this.parts.push({type:"node",index:-1}),n++}}else a.currentNode=s.pop()}for(const e of t)e.parentNode.removeChild(e)}}const h=(e,i)=>{const t=e.length-i.length;return t>=0&&e.slice(t)===i},f=e=>-1!==e.index,y=()=>document.createComment(""),k=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=\/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class b{constructor(e,i,t,s){this.strings=e,this.values=i,this.type=t,this.processor=s}getHTML(){const e=this.strings.length-1;let i="",t=!1;for(let s=0;s<e;s++){const e=this.strings[s],a=e.lastIndexOf("\x3c!--");t=(a>-1||t)&&-1===e.indexOf("--\x3e",a+1);const r=k.exec(e);i+=null===r?e+(t?c:g):e.substr(0,r.index)+r[1]+r[2]+l+r[3]+c}return i+=this.strings[e]}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const N=new class{handleAttributeExpressions(e,i,t,s){const a=i[0];return"."===a?new M(e,i.slice(1),t).parts:"@"===a?[new A(e,i.slice(1),s.eventContext)]:"?"===a?[new _(e,i.slice(1),t)]:new w(e,i,t).parts}handleTextExpression(e){return new S(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function $(e){let i=T.get(e.type);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},T.set(e.type,i));let t=i.stringsArray.get(e.strings);if(void 0!==t)return t;const s=e.strings.join(c);return void 0===(t=i.keyString.get(s))&&(t=new p(e,e.getTemplateElement()),i.keyString.set(s,t)),i.stringsArray.set(e.strings,t),t}const T=new Map,K=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.1");const R=(e,...i)=>new b(e,i,"html",N),B=133;function H(e,i){const{element:{content:t},parts:s}=e,a=document.createTreeWalker(t,B,null,!1);let r=E(s),o=s[r],n=-1,m=0;const d=[];let c=null;for(;a.nextNode();){n++;const e=a.currentNode;for(e.previousSibling===c&&(c=null),i.has(e)&&(d.push(e),null===c&&(c=e)),null!==c&&m++;void 0!==o&&o.index===n;)o.index=null!==c?-1:o.index-m,o=s[r=E(s,r)]}d.forEach(e=>e.parentNode.removeChild(e))}const D=e=>{let i=11===e.nodeType?0:1;const t=document.createTreeWalker(e,B,null,!1);for(;t.nextNode();)i++;return i},E=(e,i=-1)=>{for(let t=i+1;t<e.length;t++){const i=e[t];if(f(i))return t}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.2.1");const ue=e=>e.flat?e.flat(1/0):function e(i,t=[]){for(let s=0,a=i.length;s<a;s++){const a=i[s];Array.isArray(a)?e(a,t):t.push(a)}return t}(e);class le extends se{static finalize(){super.finalize.call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const e=this.styles,i=[];if(Array.isArray(e)){ue(e).reduceRight((e,i)=>(e.add(i),e),new Set).forEach(e=>i.unshift(e))}else e&&i.push(e);return i}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?me?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){super.update(e);const i=this.render();i instanceof b&&this.constructor.render(i,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const i=document.createElement("style");i.textContent=e.cssText,this.renderRoot.appendChild(i)}))}render(){}}function pe(...e){return e.filter(e=>!!e).join(" ")}le.finalized=!0,le.render=(e,i,t)=>{if(!t||"object"!=typeof t||!t.scopeName)throw new Error("The `scopeName` option is required.");const s=t.scopeName,a=K.has(i),r=G&&11===i.nodeType&&!!i.host,o=r&&!U.has(s),m=o?document.createDocumentFragment():i;if(((e,i,t)=>{let s=K.get(i);void 0===s&&(n(i,i.firstChild),K.set(i,s=new S(Object.assign({templateFactory:$},t))),s.appendInto(i)),s.setValue(e),s.commit()})(e,m,Object.assign({templateFactory:L(s)},t)),o){const e=K.get(m);K.delete(m);const t=e.value instanceof v?e.value.template:void 0;V(s,m,t),n(i,i.firstChild),i.appendChild(m),K.set(i,e)}!a&&r&&window.ShadyCSS.styleElement(i.host)};var he=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let fe=class extends le{constructor(){super(...arguments),this.type="button",this.primary=!1,this.danger=!1,this.icon=!1,this.disabled=!1}static get styles(){return ge`
      :host[disabled] {
        pointer-events: none;
      }
    ...
    `}handleClick(){const e=new CustomEvent("press",{bubbles:!0,composed:!0,detail:null});this.dispatchEvent(e)}};he([ne({type:String})],fe.prototype,"type",void 0),he([ne({type:Boolean})],fe.prototype,"primary",void 0),he([ne({type:Boolean})],fe.prototype,"danger",void 0),he([ne({type:Boolean})],fe.prototype,"icon",void 0),he([ne({type:Boolean})],fe.prototype,"disabled",void 0),fe=he([ae("glk-button")],fe);var ye=t(6);var ke=new(t.n(ye).a)([{name:"home",render:()=>R`
        ...
        `,url:"/options"},{name:"scores",render:()=>R`
          <glk-scores></glk-scores>
        `,url:"/scores"},{name:"decks",render:()=>R`
          <glk-decks></glk-decks>
        `,url:"/decks"},{name:"decks-builder",render:()=>R`
          <glk-decks-builder></glk-decks-builder>
        `,url:"/decks-builder"}],"/galko"),ve=t(7),be=t.n(ve),je=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ie=class extends le{constructor(){super(...arguments),this.href="",this.buttonise=!1}static get styles(){return ge`
      .router-link {
  ...
  `};function Se(e,i){switch(e){case we.LG:return xe.lg(i);case we.MD:return xe.md(i);case we.SM:return xe.sm(i);case we.XS:return xe.xs(i);case we.XXS:return xe.xxs(i)}}const _e=[{size:we.LG,num:20},{size:we.MD,num:25},{size:we.SM,num:33},{size:we.XS,num:50}].map(({size:e,num:i})=>Se(e,ge`
      .grid--standard {
  ...
  `,..._e];!function(e){e.argyle="argyle",e.blueprint="blueprint",e.chevrons="chevrons",e.honeyCombs="honeyCombs",e.shippo="shippo",e.subtleDots="subtleDots"}(Me||(Me={}));var Oe=t(4),Ae=t.n(Oe);const Ce=new Ae.a("glkOptions",{cardBack:Me.subtleDots,deckId:"",hideOnMatch:!0,startingPairs:15}),Ne=new Ae.a("glkData",{decks:[],history:[]});Ne.upgrade(e=>{if(!e)return e;const i=(e.history||[]).map(e=>({...e,turns:e.turns?e.turns:0}));return{...e,history:i}});var $e=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Te=class extends le{constructor(){super(...arguments),this.decks=[]}static get styles(){return[...Pe,ge`
        :host {
          margin: 10px;
        }
      ...
      `]}firstUpdated(){this.decks=Ne.getKey("decks")}render(){return R`
      <section class="decks">
        <header class="header">
    ...
    `}dropDeck(e){let i=Ne.getKey("decks");i=i.filter(i=>i.id!==e),Ne.set({decks:i}),this.decks=i}};$e([ne({type:Array})],Te.prototype,"decks",void 0),Te=$e([ae("glk-decks")],Te);var Ke=t(8),Re=t.n(Ke),Be=t(2),He=t.n(Be),De=t(9),Ee=t.n(De);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ze=(e,i)=>{const t=e.startNode.parentNode,s=void 0===i?e.endNode:i.startNode,a=t.insertBefore(y(),s);t.insertBefore(y(),s);const r=new S(e.options);return r.insertAfterNode(a),r},Ge=(e,i)=>(e.setValue(i),e.commit(),e),Le=(e,i,t)=>{const s=e.startNode.parentNode,a=t?t.startNode:e.endNode,r=i.endNode.nextSibling;r!==a&&o(s,i.startNode,r,a)},Fe=e=>{n(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},Ue=(e,i,t)=>{const s=new Map;for(let a=i;a<=t;a++)s.set(e[a],a);return s},Ve=new WeakMap,Ye=new WeakMap,Je=(e=>(...i)=>{const t=e(...i);return s.set(t,!0),t})((e,i,t)=>{let s;return void 0===t?t=i:void 0!==i&&(s=i),i=>{if(!(i instanceof S))throw new Error("repeat can only be used in text bindings");const a=Ve.get(i)||[],r=Ye.get(i)||[],o=[],n=[],m=[];let d,c,g=0;for(const i of e)m[g]=s?s(i,g):g,n[g]=t(i,g),g++;let u=0,l=a.length-1,p=0,h=n.length-1;for(;u<=l&&p<=h;)if(null===a[u])u++;else if(null===a[l])l--;else if(r[u]===m[p])o[p]=Ge(a[u],n[p]),u++,p++;else if(r[l]===m[h])o[h]=Ge(a[l],n[h]),l--,h--;else if(r[u]===m[h])o[h]=Ge(a[u],n[h]),Le(i,a[u],o[h+1]),u++,h--;else if(r[l]===m[p])o[p]=Ge(a[l],n[p]),Le(i,a[l],a[u]),l--,p++;else if(void 0===d&&(d=Ue(m,p,h),c=Ue(r,u,l)),d.has(r[u]))if(d.has(r[l])){const e=c.get(m[p]),t=void 0!==e?a[e]:null;if(null===t){const e=ze(i,a[u]);Ge(e,n[p]),o[p]=e}else o[p]=Ge(t,n[p]),Le(i,t,a[u]),a[e]=null;p++}else Fe(a[l]),l--;else Fe(a[u]),u++;for(;p<=h;){const e=ze(i,o[h+1]);Ge(e,n[p]),o[p++]=e}for(;u<=l;){const e=a[u++];null!==e&&Fe(e)}Ve.set(i,o),Ye.set(i,m)}});var We;!function(e){e[e.width=103]="width",e[e.height=160]="height"}(We||(We={}));var Xe=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let qe=class extends le{constructor(){super(...arguments),this.timer=0}static get styles(){return ge``}firstUpdated(){this.image=this.images[0]}render(){return R`
      <div
        class="image"
...
`,ti=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};function si(e){const i=Qe.find(i=>i.id===e);return i?i.name:"(Unknown)"}let ai=class extends le{constructor(){super(...arguments),this.noDeck=!1,this.characters=[],this.deckId="",this.deckName="",this.deckCharacterIds=[],this.search="",this.showOnlySelected=!1,this.feedback=""}static get styles(){return[ii,ei,...Pe,ge`
        .decks__title {
          font-size: 1.5rem;
          margin: 1rem 0;
        }
      ...
      <div class="decks">
        ...
        <div class="view">
          ...
          <ul class="grid grid--standard">
            ${Je(i,e=>e.id,e=>{const i=Ee()(e.name),t=[e.image,...e.images.map(e=>e.url)],s=this.deckCharacterIds.includes(e.id);return R`
                  <li
                    key=${e.id}
...
`,oi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let ni=class extends le{constructor(){super(...arguments),this.image=""}static get styles(){return ge`
      :host {
        position: absolute;
        top: 0;
        left: 0;
...
`;const gi={primaryColour:"#fdd87f",primaryColourHovered:"#999900",secondaryColour:"#51c2ea",secondaryColourHovered:"#2a87ca"};function ui(e){return function(e){const i=document.createElement("div");return i.innerHTML=function(e){const{strings:i,values:t}=e,s=i.length;let a="";for(let e=0;e<s;e++)a+=i[e]+(t[e]||"");return a}(e),"data:image/svg+xml;base64,"+window.btoa(i.innerHTML)}(function(e){switch(e){case Me.argyle:return R`
      ...
      `;case Me.subtleDots:default:return R`
        <svg xmlns="http://www.w3.org/2000/svg" width="5" height="5">
          <rect width="5" height="5" fill=${gi.primaryColour} />
          <rect width="1" height="1" fill=${gi.secondaryColour} />
        </svg>
      `}}(e))}var li=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let pi=class extends le{constructor(){super(...arguments),this.cards=[],this.selected=[],this.removed=[],this.hasMatch=!1,this.cardBack=""}static get styles(){return[ge`
        :host {
          display: grid;
        ...
        ${Se(we.XXS,ge`
          ...
          `)}
      `,ci]}firstUpdated(){const e=Ce.get();this.cardBack=ui(e.cardBack)}render(){const e=2===this.selected.length;return R`
      ${e?R`
            <style>
      ...
      ${this.cards.map(e=>{const i=this.removed.includes(e.id),t=this.selected.includes(e.id),s=[t?"glk-card--flipped":"",t&&this.hasMatch?"glk-card--matched":""].join(" ");return R`
          ...
          ></glk-card>
        `})}
    `}};li([ne({type:Array})],pi.prototype,"cards",void 0),li([ne({type:Array})],pi.prototype,"selected",void 0),li([ne({type:Array})],pi.prototype,"removed",void 0),li([ne({type:Boolean})],pi.prototype,"hasMatch",void 0),li([ne({type:String})],pi.prototype,"cardBack",void 0),pi=li([ae("glk-card-grid")],pi);var hi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let fi=class extends le{constructor(){super(...arguments),this.streak=0,this.uppedStreak=!1,this.timer=0}static get styles(){return ge`
      :host {
        padding: 5px;
      }
    ...
    `}setPulse(){clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.uppedStreak=!1},1250)}};hi([ne({type:Number})],fi.prototype,"streak",void 0),hi([ne({type:Boolean})],fi.prototype,"uppedStreak",void 0),hi([ne({type:Number})],fi.prototype,"timer",void 0),fi=hi([ae("glk-streak")],fi);var yi=t(3),ki=t.n(yi);function vi(e){const i=[e.image,...e.images.map(e=>e.url)];return ki()(i).pop()}const bi=e=>({characterId:e.id,id:He()(),image:e.image,name:e.name});var ji=t(0),Ii=t.n(ji);var wi=new class{constructor(){this.interval=0,this.paused=!0,this.gameTime=0,this.callback=()=>null}get time(){return this.formatTime(this.gameTime)}get isPaused(){return this.paused}formatTime(e){const i=Math.floor(e/60),t=e%60;return`${Ii()(i,2)}m ${Ii()(t,2)}s`}subscribe(e){return this.callback=e,this.reset(),this.start(),()=>{const e=this.gameTime;return this.callback=()=>null,this.reset(),e}}start(){this.paused=!1,clearInterval(this.interval),this.interval=window.setInterval(()=>{this.gameTime+=1,this.callback(this.time)},1e3)}stop(){this.paused=!0,clearInterval(this.interval)}reset(){this.stop(),this.gameTime=0}},xi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};const Si=ge`
  .game-bar {
...
`;let _i=class extends le{constructor(){super(...arguments),this.turns=[],this.timer=0,this.inGame=!1,this.timeElapsed="00m 00s",this.gameSummary=[],this.hasMatch=!1,this.pairs=[],this.choices=[],this.cards=[],this.unsubTimer=()=>0}static get styles(){return ge`
      :host {
    ...
    `}newGame(){this.gameSummary=[],this.turns=[],this.choices=[],this.cards=function(){const e=Ne.getKey("decks"),i=Ce.get();let t=Ze;const s=e.find(e=>e.id===i.deckId);s&&(t=Ze.filter(e=>s.characterIds.includes(e.id)));const a=ki()(t).slice(0,i.startingPairs).map(e=>({...e,image:vi(e)})),r=[...a,...a];return ki()(r).map(bi)}(),this.inGame=!0,this.unsubTimer=wi.subscribe(e=>this.timeElapsed=e)}endGame(e=!1){const i=this.unsubTimer(),t=this.pairs.length/2,s=this.turns.length,a=this.getLongestStreak();if(this.inGame=!1,this.pairs=[],this.turns=[],this.choices=this.cards.map(e=>e.id),this.gameSummary=[e?"You found all the pairs!":"Quitters always quit.",`${t} pairs found in ${wi.formatTime(i)}`,`${a} was your longest match streak`],e){const e=Ne.getKey("history");Ne.set({history:[...e,{datetime:(new Date).getTime(),longestStreak:a,pairs:t,timeElapsed:i,turns:s}]})}}onCardFlip(e){if(2===this.choices.length)return;const i=e.detail;!this.choices.includes(i.cardId)&&(this.choices=[...this.choices,i.cardId],this.checkCards())}checkCards(){if(2!==this.choices.length)return;const e=this.choices.map(e=>{const i=this.cards.find(i=>i.id===e);if(i)return i.characterId}),i=this.turns.slice(0),t=1===new Set(e).size;this.hasMatch=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{t&&(this.pairs=[...this.pairs,...this.choices]),this.turns=[...i,{number:i.length+1,isMatch:t}],this.choices=[],this.hasMatch=!1,this.checkGameState()},1500)}checkGameState(){this.cards.length===this.pairs.length&&0!==this.pairs.length&&this.endGame(!0)}getCurrentStreak(){return this.turns.slice(0).reverse().reduce((e,i)=>{const t=e.isBroken||!i.isMatch;return{streak:t?e.streak:e.streak+1,isBroken:t}},{streak:0,isBroken:!1}).streak}getLongestStreak(){return this.turns.slice(0).reduce((e,i)=>{const t=i.isMatch?e.streak+1:0;return{streak:t,longest:t>e.longest?t:e.longest}},{longest:0,streak:0}).longest}};xi([ne({type:Array})],_i.prototype,"turns",void 0),xi([ne({type:Number})],_i.prototype,"timer",void 0),xi([ne({type:Boolean})],_i.prototype,"inGame",void 0),xi([ne({type:String})],_i.prototype,"timeElapsed",void 0),xi([ne({type:Array})],_i.prototype,"gameSummary",void 0),xi([ne({type:Boolean})],_i.prototype,"hasMatch",void 0),xi([ne({type:Array})],_i.prototype,"pairs",void 0),xi([ne({type:Array})],_i.prototype,"choices",void 0),xi([ne({type:Array})],_i.prototype,"cards",void 0),xi([ne({type:Function})],_i.prototype,"unsubTimer",void 0),_i=xi([ae("glk-home")],_i);var Mi=t(11),Pi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};const Oi=Object.keys(Me);let Ai=class extends le{constructor(){super(...arguments),this.decks=[],this.startingPairs=0,this.cardBack=Me.subtleDots,this.deckId="",this.hideOnMatch=!0}static get styles(){return[ii,ei,ge`
        :host {
          margin: 10px;
        }
      ...
      `]}firstUpdated(){const e=Ce.get();this.decks=Ne.getKey("decks"),this.startingPairs=e.startingPairs,this.cardBack=e.cardBack,this.hideOnMatch=e.hideOnMatch,this.deckId=e.deckId}render(){const e=this.isValidForm(),i=e.success,t=e.messages;return R`
      <div class="options">
            ...
            >
              ${Oi.map(e=>R`
                  <option value=${e} ?selected=${e===this.cardBack}
                    >${Object(Mi.separateAndCapitalise)(e)}</option
                  >
                `)}
            </select>
          </div>
    ...
    `}onUserInput(e){const i=e.target,t=Number(i.value);this.startingPairs=t}onSelect(e){const i=e.target,t=i.name;"cardBack"===t?this.cardBack=i.value:"deckId"===t&&(this.deckId=i.value)}onToggle(e){const i=e.target;this.hideOnMatch=i.checked}isValidForm(){const e=[],i=this.startingPairs>=1&&this.startingPairs<=26;i||e.push("Starting pairs must be 1 <= n <= 26");const t=this.decks.find(e=>e.id===this.deckId),s=!t||t.characterIds.length>=this.startingPairs;return s||e.push("The deck chosen has fewer characters than the number of pairs requested."),{messages:e.join("\r\n"),success:i&&s}}handleSave(e){e.preventDefault(),this.isValidForm().success&&(Ce.set({cardBack:this.cardBack,deckId:this.deckId,hideOnMatch:this.hideOnMatch,startingPairs:this.startingPairs}),ke.push("/"))}};Pi([ne({type:Array})],Ai.prototype,"decks",void 0),Pi([ne({type:Number})],Ai.prototype,"startingPairs",void 0),Pi([ne({type:String})],Ai.prototype,"cardBack",void 0),Pi([ne({type:String})],Ai.prototype,"deckId",void 0),Pi([ne({type:Boolean})],Ai.prototype,"hideOnMatch",void 0),Ai=Pi([ae("glk-options")],Ai);var Ci=t(12),Ni=t.n(Ci),$i=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ti=class extends le{constructor(){super(...arguments),this.show=!1,this.direction=0}static get styles(){return ge`
      .icon {
    ...
    `}};$i([ne({type:Boolean})],Ti.prototype,"show",void 0),$i([ne({type:Number})],Ti.prototype,"direction",void 0),Ti=$i([ae("glk-sort-icon")],Ti);var Ki=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ri=class extends le{constructor(){super(...arguments),this.sortField="matchAttemptsRatio",this.sortOrder=-1,this.history=[]}static get styles(){return[ge`
        :host {
          margin: 10px;
        }
        ...
        ${Se(we.XXS,ge`
          ...
          `)}
      `]}firstUpdated(){const e=Ne.getKey("history");this.history=e.map(e=>({...e,date:Ni()(e.datetime),matchAttemptsRatio:0!==e.turns?e.pairs/e.turns:0,timeElapsedDisplay:wi.formatTime(e.timeElapsed)}))}render(){const e=this.history.sort((e,i)=>{const t=i[this.sortField],s=e[this.sortField];return 1===this.sortOrder?s-t:t-s});return R`
    ...
    `}itemNumber(e){return`#${Ii()(e+1,3)}`}handleSort(e){this.sortField===e&&(this.sortOrder=1===this.sortOrder?-1:1),this.sortField=e}};Ki([ne({type:Array})],Ri.prototype,"sortField",void 0),Ki([ne({type:Array})],Ri.prototype,"sortOrder",void 0),Ki([ne({type:Array})],Ri.prototype,"history",void 0),Ri=Ki([ae("glk-scores")],Ri);var Bi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Hi=class extends le{constructor(){super(...arguments),this.routeKey=""}firstUpdated(){ke.subscribe(({key:e})=>this.routeKey=e)}render(){let e=ke.currentRoute;return e||(e={name:"404",render:()=>R`
          <h2>We couldn't find what you were looking for.</h2>
          <div>
            <glk-router-link .href=${ke.base}
              >Return to Home</glk-router-link
        ...
        `,url:""}),e.render(this.routeKey)}};Bi([ne({type:String})],Hi.prototype,"routeKey",void 0),Hi=Bi([ae("glk-router-view")],Hi);var Di=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ei=class extends le{constructor(){super(...arguments),this.text="",this.delay=750,this.allowWrapping=!1,this.usePosition=!1,this.timer=0,this.isHovered=!1,this.at=[]}static get styles(){return ge`
      .tooltip {
        position: relative;
      }
      .tooltip__content {
    ...
    `}handleEnter(e){const{clientX:i,clientY:t}=e,s=this.shadowRoot.querySelector(".tooltip");let a=0;if(s&&s.firstChild){const e=s.getBoundingClientRect(),i=s.firstChild.offsetWidth,t=window.innerWidth-(e.width+e.left);i>e.left+e.width/2?a=-e.left:t<i&&(a=-(i-t))}clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.isHovered=!0,this.at=[i,t,a]},this.delay)}handleLeave(){clearTimeout(this.timer),this.isHovered=!1,this.at=[]}};Di([ne({type:String})],Ei.prototype,"text",void 0),Di([ne({type:Number})],Ei.prototype,"delay",void 0),Di([ne({type:Boolean})],Ei.prototype,"allowWrapping",void 0),Di([ne({type:Boolean})],Ei.prototype,"usePosition",void 0),Di([ne({type:Number})],Ei.prototype,"timer",void 0),Di([ne({type:Boolean})],Ei.prototype,"isHovered",void 0),Di([ne({type:Array})],Ei.prototype,"at",void 0),Ei=Di([ae("glk-tooltip")],Ei);var zi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(e=>console.log("SW registered: ",e)).catch(e=>console.log("SW registration failed: ",e))});let Gi=class extends le{static get styles(){return ge`
      :host,
      main {
