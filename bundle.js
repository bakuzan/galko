 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const T=new class{handleAttributeExpressions(t,e,i,r){const s=e[0];return"."===s?new C(t,e.slice(1),i).parts:"@"===s?[new N(t,e.slice(1),r.eventContext)]:"?"===s?[new P(t,e.slice(1),i)]:new _(t,e,i).parts}handleTextExpression(t){return new S(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.2.1");const ht=t=>t.flat?t.flat(1/0):function t(e,i=[]){for(let r=0,s=e.length;r<s;r++){const s=e[r];Array.isArray(s)?t(s,i):i.push(s)}return i}(t);class pt extends it{static finalize(){super.finalize.call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const t=this.styles,e=[];if(Array.isArray(t)){ht(t).reduceRight((t,e)=>(t.add(e),t),new Set).forEach(t=>e.unshift(t))}else t&&e.push(t);return e}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?at?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){super.update(t);const e=this.render();e instanceof v&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){}}pt.finalized=!0,pt.render=(t,e,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const r=i.scopeName,s=R.has(e),o=L&&11===e.nodeType&&!!e.host,a=o&&!F.has(r),l=a?document.createDocumentFragment():e;if(((t,e,i)=>{let r=R.get(e);void 0===r&&(n(e,e.firstChild),R.set(e,r=new S(Object.assign({templateFactory:A},i))),r.appendInto(e)),r.setValue(t),r.commit()})(t,l,Object.assign({templateFactory:I(r)},i)),a){const t=R.get(l);R.delete(l);const i=t.value instanceof b?t.value.template:void 0;G(r,l,i),n(e,e.firstChild),e.appendChild(l),R.set(e,t)}!s&&o&&window.ShadyCSS.styleElement(e.host)};var ut=function(t,e,i,r){var s,o=arguments.length,n=o<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(o<3?s(n):o>3?s(e,i,n):s(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};let mt=class extends pt{constructor(){super(...arguments),this.type="button",this.primary=!1,this.icon=!1,this.disabled=!1}static get styles(){return dt`
    ...
    `}handleClick(){const t=new CustomEvent("press",{bubbles:!0,composed:!0,detail:null});this.dispatchEvent(t)}};ut([nt({type:String})],mt.prototype,"type",void 0),ut([nt({type:Boolean})],mt.prototype,"primary",void 0),ut([nt({type:Boolean})],mt.prototype,"icon",void 0),ut([nt({type:Boolean})],mt.prototype,"disabled",void 0),mt=ut([rt("glk-button")],mt);var gt=()=>(`${1e7}`+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,t=>{const e=Number(t);return(e^window.crypto.getRandomValues(new Uint8Array(1))[0]&15>>e/4).toString(16)});var ft=new class{constructor(t,e="/"){this.appRoutes=[],this.baseUrl="/",this.listeners=[],this.appRoutes=t,this.baseUrl=e,this.listenToPopState()}get currentRoute(){const t=`/${window.location.pathname.replace(this.baseUrl,"")}`;return this.appRoutes.find(e=>e.url===t)}subscribe(t){this.listeners.push(t)}push(t){const e=this.currentRoute,i=this.appRoutes.find(e=>e.url===t);if(!i)return;const r=`${this.baseUrl}${t}`.replace(/\/\//g,"/"),s=`${window.location.origin}${r}`;window.history.pushState(null,"",s),this.publishChange(i,e)}listenToPopState(){window.onpopstate=t=>{const e=`/${window.location.pathname.replace(this.baseUrl,"")}`,i=this.appRoutes.find(t=>t.url===e);i&&this.publishChange(i)}}publishChange(t,e){const i={key:gt(),fromRoute:e,toRoute:t};this.listeners.forEach(t=>t(i))}}([{name:"home",render:()=>E`
          <glk-home></glk-home>
    ...
    `}render(){const t=`router-link${this.buttonise?" router-link--as-button":""}`;return E`
      <a class="${t}" href="${this.href}" @click=${this.handleClick}>
        <slot></slot>
      </a>
    `}handleClick(t){if(function(t){if(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)return;if(t.defaultPrevented)return;if(void 0!==t.button&&0!==t.button)return;const e=t.currentTarget;if(e&&e.getAttribute){const t=e.getAttribute("target")||"";if(/\b_blank\b/i.test(t))return}return t.preventDefault(),!0}(t)){const t=this.resolveLocation();ft.push(t)}}resolveLocation(){return this.href}};yt([nt({type:String})],bt.prototype,"href",void 0),yt([nt({type:Boolean})],bt.prototype,"buttonise",void 0),bt=yt([rt("glk-router-link")],bt);var vt,xt=E`
  <style>
    @keyframes growth {
      0% {
        transform: scale(0);
...
`,$t=function(t,e,i,r){var s,o=arguments.length,n=o<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(o<3?s(n):o>3?s(e,i,n):s(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};let jt=class extends pt{constructor(){super(...arguments),this.image=""}static get styles(){return dt`
      :host {
        position: absolute;
        top: 0;
        left: 0;
    ...
    `}firstUpdated(){const t=St.get();this.cardBack=_t(t.cardBack)}render(){const t=2===this.selected.length;return E`
      ${xt}
      ${t?E`
            <style>
  ...
  `};function It(t,e){switch(t){case Et.SM:return Lt.sm(e);case Et.XS:return Lt.xs(e);default:return dt``}}var Dt=function(t,e,i,r){var s,o=arguments.length,n=o<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(o<3?s(n):o>3?s(e,i,n):s(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};const Ft=dt`
  .game-bar {
...
`;const Kt=((...t)=>t.reduce((t,e)=>(...i)=>t(e(...i))))(t=>t.charAt(0).toUpperCase()+t.slice(1),(t,e=" ")=>t.replace(/([a-z\d])([A-Z])/g,"$1"+e+"$2").replace(/([A-Z]+)([A-Z][a-z\d]+)/g,"$1"+e+"$2").toLowerCase());var Yt=function(t,e,i,r){var s,o=arguments.length,n=o<3?e:null===r?r=Object.getOwnPropertyDescriptor(e,i):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(n=(o<3?s(n):o>3?s(e,i,n):s(e,i))||n);return o>3&&n&&Object.defineProperty(e,i,n),n};const Wt=Object.keys(vt);let Jt=class extends pt{constructor(){super(...arguments),this.startingPairs=0,this.cardBack=vt.subtleDots,this.hideOnMatch=!0}static get styles(){return[qt,dt`
        :host {
          margin: 10px;
        }
      ...
      <main>
        <nav class="action-bar">
          <h1 class="action-bar__title">
            <glk-router-link ?buttonise=${!0} href="/"
