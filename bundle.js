 ...
 */
const s="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,a=(e,i,t=null,s=null)=>{for(;i!==t;){const t=i.nextSibling;e.insertBefore(i,s),i=t}},r=(e,i,t=null)=>{for(;i!==t;){const t=i.nextSibling;e.removeChild(i),i=t}},o=`{{lit-${String(Math.random()).slice(2)}}}`,n=`\x3c!--${o}--\x3e`,m=new RegExp(`${o}|${n}`);class d{constructor(e,i){this.parts=[],this.element=i;const t=[],s=[],a=document.createTreeWalker(i.content,133,null,!1);let r=0,n=-1,d=0;const{strings:g,values:{length:p}}=e;for(;d<p;){const e=a.nextNode();if(null!==e){if(n++,1===e.nodeType){if(e.hasAttributes()){const i=e.attributes,{length:t}=i;let s=0;for(let e=0;e<t;e++)c(i[e].name,"$lit$")&&s++;for(;s-- >0;){const i=g[d],t=l.exec(i)[2],s=t.toLowerCase()+"$lit$",a=e.getAttribute(s);e.removeAttribute(s);const r=a.split(m);this.parts.push({type:"attribute",index:n,name:t,strings:r}),d+=r.length-1}}"TEMPLATE"===e.tagName&&(s.push(e),a.currentNode=e.content)}else if(3===e.nodeType){const i=e.data;if(i.indexOf(o)>=0){const s=e.parentNode,a=i.split(m),r=a.length-1;for(let i=0;i<r;i++){let t,r=a[i];if(""===r)t=u();else{const e=l.exec(r);null!==e&&c(e[2],"$lit$")&&(r=r.slice(0,e.index)+e[1]+e[2].slice(0,-"$lit$".length)+e[3]),t=document.createTextNode(r)}s.insertBefore(t,e),this.parts.push({type:"node",index:++n})}""===a[r]?(s.insertBefore(u(),e),t.push(e)):e.data=a[r],d+=r}}else if(8===e.nodeType)if(e.data===o){const i=e.parentNode;null!==e.previousSibling&&n!==r||(n++,i.insertBefore(u(),e)),r=n,this.parts.push({type:"node",index:n}),null===e.nextSibling?e.data="":(t.push(e),n--),d++}else{let i=-1;for(;-1!==(i=e.data.indexOf(o,i+1));)this.parts.push({type:"node",index:-1}),d++}}else a.currentNode=s.pop()}for(const e of t)e.parentNode.removeChild(e)}}const c=(e,i)=>{const t=e.length-i.length;return t>=0&&e.slice(t)===i},g=e=>-1!==e.index,u=()=>document.createComment(""),l=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function p(e,i){const{element:{content:t},parts:s}=e,a=document.createTreeWalker(t,133,null,!1);let r=f(s),o=s[r],n=-1,m=0;const d=[];let c=null;for(;a.nextNode();){n++;const e=a.currentNode;for(e.previousSibling===c&&(c=null),i.has(e)&&(d.push(e),null===c&&(c=e)),null!==c&&m++;void 0!==o&&o.index===n;)o.index=null!==c?-1:o.index-m,r=f(s,r),o=s[r]}d.forEach(e=>e.parentNode.removeChild(e))}const h=e=>{let i=11===e.nodeType?0:1;const t=document.createTreeWalker(e,133,null,!1);for(;t.nextNode();)i++;return i},f=(e,i=-1)=>{for(let t=i+1;t<e.length;t++){const i=e[t];if(g(i))return t}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const y=new WeakMap,k=e=>"function"==typeof e&&y.has(e),v={},b={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class j{constructor(e,i,t){this.__parts=[],this.template=e,this.processor=i,this.options=t}update(e){let i=0;for(const t of this.__parts)void 0!==t&&t.setValue(e[i]),i++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=s?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),i=[],t=this.template.parts,a=document.createTreeWalker(e,133,null,!1);let r,o=0,n=0,m=a.nextNode();for(;o<t.length;)if(r=t[o],g(r)){for(;n<r.index;)n++,"TEMPLATE"===m.nodeName&&(i.push(m),a.currentNode=m.content),null===(m=a.nextNode())&&(a.currentNode=i.pop(),m=a.nextNode());if("node"===r.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(m.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(m,r.name,r.strings,this.options));o++}else this.__parts.push(void 0),o++;return s&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const I=` ${o} `;class w{constructor(e,i,t,s){this.strings=e,this.values=i,this.type=t,this.processor=s}getHTML(){const e=this.strings.length-1;let i="",t=!1;for(let s=0;s<e;s++){const e=this.strings[s],a=e.lastIndexOf("\x3c!--");t=(a>-1||t)&&-1===e.indexOf("--\x3e",a+1);const r=l.exec(e);i+=null===r?e+(t?I:n):e.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+o}return i+=this.strings[e],i}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const S=e=>null===e||!("object"==typeof e||"function"==typeof e),x=e=>Array.isArray(e)||!(!e||!e[Symbol.iterator]);class _{constructor(e,i,t){this.dirty=!0,this.element=e,this.name=i,this.strings=t,this.parts=[];for(let e=0;e<t.length-1;e++)this.parts[e]=this._createPart()}_createPart(){return new P(this)}_getValue(){const e=this.strings,i=e.length-1;let t="";for(let s=0;s<i;s++){t+=e[s];const i=this.parts[s];if(void 0!==i){const e=i.value;if(S(e)||!x(e))t+="string"==typeof e?e:String(e);else for(const i of e)t+="string"==typeof i?i:String(i)}}return t+=e[i],t}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class P{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===v||S(e)&&e===this.value||(this.value=e,k(e)||(this.committer.dirty=!0))}commit(){for(;k(this.value);){const e=this.value;this.value=v,e(this)}this.value!==v&&this.committer.commit()}}class O{constructor(e){this.value=void 0,this.__pendingValue=void 0,this.options=e}appendInto(e){this.startNode=e.appendChild(u()),this.endNode=e.appendChild(u())}insertAfterNode(e){this.startNode=e,this.endNode=e.nextSibling}appendIntoPart(e){e.__insert(this.startNode=u()),e.__insert(this.endNode=u())}insertAfterPart(e){e.__insert(this.startNode=u()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this.__pendingValue=e}commit(){if(null===this.startNode.parentNode)return;for(;k(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=v,e(this)}const e=this.__pendingValue;e!==v&&(S(e)?e!==this.value&&this.__commitText(e):e instanceof w?this.__commitTemplateResult(e):e instanceof Node?this.__commitNode(e):x(e)?this.__commitIterable(e):e===b?(this.value=b,this.clear()):this.__commitText(e))}__insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}__commitNode(e){this.value!==e&&(this.clear(),this.__insert(e),this.value=e)}__commitText(e){const i=this.startNode.nextSibling,t="string"==typeof(e=null==e?"":e)?e:String(e);i===this.endNode.previousSibling&&3===i.nodeType?i.data=t:this.__commitNode(document.createTextNode(t)),this.value=e}__commitTemplateResult(e){const i=this.options.templateFactory(e);if(this.value instanceof j&&this.value.template===i)this.value.update(e.values);else{const t=new j(i,e.processor,this.options),s=t._clone();t.update(e.values),this.__commitNode(s),this.value=t}}__commitIterable(e){Array.isArray(this.value)||(this.value=[],this.clear());const i=this.value;let t,s=0;for(const a of e)t=i[s],void 0===t&&(t=new O(this.options),i.push(t),0===s?t.appendIntoPart(this):t.insertAfterPart(i[s-1])),t.setValue(a),t.commit(),s++;s<i.length&&(i.length=s,this.clear(t&&t.endNode))}clear(e=this.startNode){r(this.startNode.parentNode,e.nextSibling,this.endNode)}}class M{constructor(e,i,t){if(this.value=void 0,this.__pendingValue=void 0,2!==t.length||""!==t[0]||""!==t[1])throw new Error("Boolean attributes can only contain a single expression");this.element=e,this.name=i,this.strings=t}setValue(e){this.__pendingValue=e}commit(){for(;k(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=v,e(this)}if(this.__pendingValue===v)return;const e=!!this.__pendingValue;this.value!==e&&(e?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=e),this.__pendingValue=v}}class A extends _{constructor(e,i,t){super(e,i,t),this.single=2===t.length&&""===t[0]&&""===t[1]}_createPart(){return new $(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class $ extends P{}let N=!1;(()=>{try{const e={get capture(){return N=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}})();class T{constructor(e,i,t){this.value=void 0,this.__pendingValue=void 0,this.element=e,this.eventName=i,this.eventContext=t,this.__boundHandleEvent=e=>this.handleEvent(e)}setValue(e){this.__pendingValue=e}commit(){for(;k(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=v,e(this)}if(this.__pendingValue===v)return;const e=this.__pendingValue,i=this.value,t=null==e||null!=i&&(e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive),s=null!=e&&(null==i||t);t&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),s&&(this.__options=C(e),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=e,this.__pendingValue=v}handleEvent(e){"function"==typeof this.value?this.value.call(this.eventContext||this.element,e):this.value.handleEvent(e)}}const C=e=>e&&(N?{capture:e.capture,passive:e.passive,once:e.once}:e.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function K(e){let i=R.get(e.type);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},R.set(e.type,i));let t=i.stringsArray.get(e.strings);if(void 0!==t)return t;const s=e.strings.join(o);return t=i.keyString.get(s),void 0===t&&(t=new d(e,e.getTemplateElement()),i.keyString.set(s,t)),i.stringsArray.set(e.strings,t),t}const R=new Map,B=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,i,t,s){const a=i[0];if("."===a){return new A(e,i.slice(1),t).parts}return"@"===a?[new T(e,i.slice(1),s.eventContext)]:"?"===a?[new M(e,i.slice(1),t)]:new _(e,i,t).parts}handleTextExpression(e){return new O(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const H=(e,...i)=>new w(e,i,"html",D),E=(e,i)=>`${e}--${i}`;let z=!0;void 0===window.ShadyCSS?z=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),z=!1);const G=e=>i=>{const t=E(i.type,e);let s=R.get(t);void 0===s&&(s={stringsArray:new WeakMap,keyString:new Map},R.set(t,s));let a=s.stringsArray.get(i.strings);if(void 0!==a)return a;const r=i.strings.join(o);if(a=s.keyString.get(r),void 0===a){const t=i.getTemplateElement();z&&window.ShadyCSS.prepareTemplateDom(t,e),a=new d(i,t),s.keyString.set(r,a)}return s.stringsArray.set(i.strings,a),a},U=["html","svg"],L=new Set,F=(e,i,t)=>{L.add(e);const s=t?t.element:document.createElement("template"),a=i.querySelectorAll("style"),{length:r}=a;if(0===r)return void window.ShadyCSS.prepareTemplateStyles(s,e);const o=document.createElement("style");for(let e=0;e<r;e++){const i=a[e];i.parentNode.removeChild(i),o.textContent+=i.textContent}(e=>{U.forEach(i=>{const t=R.get(E(i,e));void 0!==t&&t.keyString.forEach(e=>{const{element:{content:i}}=e,t=new Set;Array.from(i.querySelectorAll("style")).forEach(e=>{t.add(e)}),p(e,t)})})})(e);const n=s.content;t?function(e,i,t=null){const{element:{content:s},parts:a}=e;if(null==t)return void s.appendChild(i);const r=document.createTreeWalker(s,133,null,!1);let o=f(a),n=0,m=-1;for(;r.nextNode();){for(m++,r.currentNode===t&&(n=h(i),t.parentNode.insertBefore(i,t));-1!==o&&a[o].index===m;){if(n>0){for(;-1!==o;)a[o].index+=n,o=f(a,o);return}o=f(a,o)}}}(t,o,n.firstChild):n.insertBefore(o,n.firstChild),window.ShadyCSS.prepareTemplateStyles(s,e);const m=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==m)i.insertBefore(m.cloneNode(!0),i.firstChild);else if(t){n.insertBefore(o,n.firstChild);const e=new Set;e.add(o),p(t,e)}};window.JSCompiler_renameProperty=(e,i)=>e;const V={toAttribute(e,i){switch(i){case Boolean:return e?"":null;case Object:case Array:return null==e?e:JSON.stringify(e)}return e},fromAttribute(e,i){switch(i){case Boolean:return null!==e;case Number:return null===e?null:Number(e);case Object:case Array:return JSON.parse(e)}return e}},Y=(e,i)=>i!==e&&(i==i||e==e),J={attribute:!0,type:String,converter:V,reflect:!1,hasChanged:Y};class W extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=new Promise(e=>this._enableUpdatingResolver=e),this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const e=[];return this._classProperties.forEach((i,t)=>{const s=this._attributeNameForProperty(t,i);void 0!==s&&(this._attributeToPropertyMap.set(s,t),e.push(s))}),e}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const e=Object.getPrototypeOf(this)._classProperties;void 0!==e&&e.forEach((e,i)=>this._classProperties.set(i,e))}}static createProperty(e,i=J){if(this._ensureClassProperties(),this._classProperties.set(e,i),i.noAccessor||this.prototype.hasOwnProperty(e))return;const t="symbol"==typeof e?Symbol():`__${e}`,s=this.getPropertyDescriptor(e,t,i);void 0!==s&&Object.defineProperty(this.prototype,e,s)}static getPropertyDescriptor(e,i,t){return{get(){return this[i]},set(t){const s=this[e];this[i]=t,this._requestUpdate(e,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this._classProperties&&this._classProperties.get(e)||J}static finalize(){const e=Object.getPrototypeOf(this);if(e.hasOwnProperty("finalized")||e.finalize(),this.finalized=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const e=this.properties,i=[...Object.getOwnPropertyNames(e),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(e):[]];for(const t of i)this.createProperty(t,e[t])}}static _attributeNameForProperty(e,i){const t=i.attribute;return!1===t?void 0:"string"==typeof t?t:"string"==typeof e?e.toLowerCase():void 0}static _valueHasChanged(e,i,t=Y){return t(e,i)}static _propertyValueFromAttribute(e,i){const t=i.type,s=i.converter||V,a="function"==typeof s?s:s.fromAttribute;return a?a(e,t):e}static _propertyValueToAttribute(e,i){if(void 0===i.reflect)return;const t=i.type,s=i.converter;return(s&&s.toAttribute||V.toAttribute)(e,t)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((e,i)=>{if(this.hasOwnProperty(i)){const e=this[i];delete this[i],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(i,e)}})}_applyInstanceProperties(){this._instanceProperties.forEach((e,i)=>this[i]=e),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(e,i,t){i!==t&&this._attributeToProperty(e,t)}_propertyToAttribute(e,i,t=J){const s=this.constructor,a=s._attributeNameForProperty(e,t);if(void 0!==a){const e=s._propertyValueToAttribute(i,t);if(void 0===e)return;this._updateState=8|this._updateState,null==e?this.removeAttribute(a):this.setAttribute(a,e),this._updateState=-9&this._updateState}}_attributeToProperty(e,i){if(8&this._updateState)return;const t=this.constructor,s=t._attributeToPropertyMap.get(e);if(void 0!==s){const e=t.getPropertyOptions(s);this._updateState=16|this._updateState,this[s]=t._propertyValueFromAttribute(i,e),this._updateState=-17&this._updateState}}_requestUpdate(e,i){let t=!0;if(void 0!==e){const s=this.constructor,a=s.getPropertyOptions(e);s._valueHasChanged(this[e],i,a.hasChanged)?(this._changedProperties.has(e)||this._changedProperties.set(e,i),!0!==a.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(e,a))):t=!1}!this._hasRequestedUpdate&&t&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(e,i){return this._requestUpdate(e,i),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(e){}const e=this.performUpdate();return null!=e&&await e,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let e=!1;const i=this._changedProperties;try{e=this.shouldUpdate(i),e?this.update(i):this._markUpdated()}catch(i){throw e=!1,this._markUpdated(),i}e&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(i)),this.updated(i))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(e){return!0}update(e){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((e,i)=>this._propertyToAttribute(i,this[i],e)),this._reflectingProperties=void 0),this._markUpdated()}updated(e){}firstUpdated(e){}}W.finalized=!0;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const X=e=>i=>"function"==typeof i?((e,i)=>(window.customElements.define(e,i),i))(e,i):((e,i)=>{const{kind:t,elements:s}=i;return{kind:t,elements:s,finisher(i){window.customElements.define(e,i)}}})(e,i),q=(e,i)=>"method"===i.kind&&i.descriptor&&!("value"in i.descriptor)?Object.assign(Object.assign({},i),{finisher(t){t.createProperty(i.key,e)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof i.initializer&&(this[i.key]=i.initializer.call(this))},finisher(t){t.createProperty(i.key,e)}};function Z(e){return(i,t)=>void 0!==t?((e,i,t)=>{i.constructor.createProperty(t,e)})(e,i,t):q(e,i)}
/**
@license
...
*/
const Q="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ee=Symbol();class ie{constructor(e,i){if(i!==ee)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){return void 0===this._styleSheet&&(Q?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const te=(e,...i)=>{const t=i.reduce((i,t,s)=>i+(e=>{if(e instanceof ie)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(t)+e[s+1],e[0]);return new ie(t,ee)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const se={};class ae extends W{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(void 0===e)this._styles=[];else if(Array.isArray(e)){const i=(e,t)=>e.reduceRight((e,t)=>Array.isArray(t)?i(t,e):(e.add(t),e),t),t=i(e,new Set),s=[];t.forEach(e=>s.unshift(e)),this._styles=s}else this._styles=[e]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Q?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const i=this.render();super.update(e),i!==se&&this.constructor.render(i,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const i=document.createElement("style");i.textContent=e.cssText,this.renderRoot.appendChild(i)}))}render(){return se}}function re(...e){return e.filter(e=>!!e).join(" ")}ae.finalized=!0,ae.render=(e,i,t)=>{if(!t||"object"!=typeof t||!t.scopeName)throw new Error("The `scopeName` option is required.");const s=t.scopeName,a=B.has(i),o=z&&11===i.nodeType&&!!i.host,n=o&&!L.has(s),m=n?document.createDocumentFragment():i;if(((e,i,t)=>{let s=B.get(i);void 0===s&&(r(i,i.firstChild),B.set(i,s=new O(Object.assign({templateFactory:K},t))),s.appendInto(i)),s.setValue(e),s.commit()})(e,m,Object.assign({templateFactory:G(s)},t)),n){const e=B.get(m);B.delete(m);const t=e.value instanceof j?e.value.template:void 0;F(s,m,t),r(i,i.firstChild),i.appendChild(m),B.set(i,e)}!a&&o&&window.ShadyCSS.styleElement(i.host)};var oe=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let ne=class extends ae{constructor(){super(...arguments),this.type="button",this.primary=!1,this.danger=!1,this.icon=!1,this.disabled=!1}static get styles(){return te`
      :host[disabled] {
        pointer-events: none;
      }
    ...
    `}render(){const e=re("button",this.primary&&"button--primary",this.icon&&"button--icon",this.danger&&"button--danger");return H`
      <button
        type="${this.type}"
        class="${e}"
    ...
    `}handleClick(){const e=new CustomEvent("press",{bubbles:!0,composed:!0,detail:null});this.dispatchEvent(e)}};oe([Z({type:String})],ne.prototype,"type",void 0),oe([Z({type:Boolean})],ne.prototype,"primary",void 0),oe([Z({type:Boolean})],ne.prototype,"danger",void 0),oe([Z({type:Boolean})],ne.prototype,"icon",void 0),oe([Z({type:Boolean})],ne.prototype,"disabled",void 0),ne=oe([X("glk-button")],ne);var me=t(6);var de=new(t.n(me).a)([{name:"home",render:()=>H`
          <glk-home></glk-home>
        `,url:"/galko"},{name:"options",render:()=>H`
          <glk-options></glk-options>
        `,title:"Options",url:"/options"},{name:"scores",render:()=>H`
          <glk-scores></glk-scores>
        `,title:"Scores",url:"/scores"},{name:"decks",render:()=>H`
          <glk-decks></glk-decks>
        `,title:"Decks",url:"/decks"},{name:"decks-builder",render:()=>H`
          <glk-decks-builder></glk-decks-builder>
        `,title:"Deck Builder",url:"/decks-builder"}],{baseUrl:"/galko",baseTitle:"Galko"}),ce=t(7),ge=t.n(ce),ue=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let le=class extends ae{constructor(){super(...arguments),this.href="",this.buttonise=!1}static get styles(){return te`
      .router-link {
    ...
    `}render(){const e=`router-link${this.buttonise?" router-link--as-button":""}`,i=this.resolveLocation();return H`
      <a class="${e}" href="${i}" @click=${this.handleClick}>
        <slot></slot>
      </a>
    `}handleClick(e){if(ge()(e)){const e=this.resolveLocation();de.push(e)}}resolveLocation(){const e=this.href.startsWith(de.base)?this.href:`${de.base}${this.href}`;return de.guardPath(e,!1)}};var pe;ue([Z({type:String})],le.prototype,"href",void 0),ue([Z({type:Boolean})],le.prototype,"buttonise",void 0),le=ue([X("glk-router-link")],le),function(e){e.XXS="xxs",e.XS="xs",e.SM="sm",e.MD="md",e.LG="lg"}(pe||(pe={}));const he=e=>te`
  ...
  `;function be(e,i){switch(e){case pe.LG:return he(i);case pe.MD:return fe(i);case pe.SM:return ye(i);case pe.XS:return ke(i);case pe.XXS:return ve(i)}}const je=[{size:pe.LG,num:20},{size:pe.MD,num:25},{size:pe.SM,num:33},{size:pe.XS,num:50}].map(({size:e,num:i})=>be(e,te`
      .grid--standard {
  ...
  `,...je];!function(e){e.argyle="argyle",e.blueprint="blueprint",e.chevrons="chevrons",e.honeyCombs="honeyCombs",e.shippo="shippo",e.subtleDots="subtleDots"}(Ie||(Ie={}));var Se=t(4),xe=t.n(Se);const _e=new xe.a("glkOptions",{cardBack:Ie.subtleDots,deckId:"",hideOnMatch:!0,startingPairs:15}),Pe=new xe.a("glkData",{decks:[],history:[]});Pe.upgrade(e=>{if(!e)return e;const i=(e.history||[]).map(e=>({...e,turns:e.turns?e.turns:0}));return{...e,history:i}});var Oe=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Me=class extends ae{constructor(){super(...arguments),this.decks=[]}static get styles(){return[...we,te`
        :host {
          margin: 10px;
        }
      ...
      `]}firstUpdated(){this.decks=Pe.getKey("decks")}render(){return H`
      <section class="decks">
        <header class="header">
    ...
    `}dropDeck(e){let i=Pe.getKey("decks");i=i.filter(i=>i.id!==e),Pe.set({decks:i}),this.decks=i}};Oe([Z({type:Array})],Me.prototype,"decks",void 0),Me=Oe([X("glk-decks")],Me);var Ae=t(8),$e=t.n(Ae),Ne=t(2),Te=t.n(Ne),Ce=t(9),Ke=t.n(Ce);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Re=(e,i)=>{const t=e.startNode.parentNode,s=void 0===i?e.endNode:i.startNode,a=t.insertBefore(u(),s);t.insertBefore(u(),s);const r=new O(e.options);return r.insertAfterNode(a),r},Be=(e,i)=>(e.setValue(i),e.commit(),e),De=(e,i,t)=>{const s=e.startNode.parentNode,r=t?t.startNode:e.endNode,o=i.endNode.nextSibling;o!==r&&a(s,i.startNode,o,r)},He=e=>{r(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},Ee=(e,i,t)=>{const s=new Map;for(let a=i;a<=t;a++)s.set(e[a],a);return s},ze=new WeakMap,Ge=new WeakMap,Ue=(Le=(e,i,t)=>{let s;return void 0===t?t=i:void 0!==i&&(s=i),i=>{if(!(i instanceof O))throw new Error("repeat can only be used in text bindings");const a=ze.get(i)||[],r=Ge.get(i)||[],o=[],n=[],m=[];let d,c,g=0;for(const i of e)m[g]=s?s(i,g):g,n[g]=t(i,g),g++;let u=0,l=a.length-1,p=0,h=n.length-1;for(;u<=l&&p<=h;)if(null===a[u])u++;else if(null===a[l])l--;else if(r[u]===m[p])o[p]=Be(a[u],n[p]),u++,p++;else if(r[l]===m[h])o[h]=Be(a[l],n[h]),l--,h--;else if(r[u]===m[h])o[h]=Be(a[u],n[h]),De(i,a[u],o[h+1]),u++,h--;else if(r[l]===m[p])o[p]=Be(a[l],n[p]),De(i,a[l],a[u]),l--,p++;else if(void 0===d&&(d=Ee(m,p,h),c=Ee(r,u,l)),d.has(r[u]))if(d.has(r[l])){const e=c.get(m[p]),t=void 0!==e?a[e]:null;if(null===t){const e=Re(i,a[u]);Be(e,n[p]),o[p]=e}else o[p]=Be(t,n[p]),De(i,t,a[u]),a[e]=null;p++}else He(a[l]),l--;else He(a[u]),u++;for(;p<=h;){const e=Re(i,o[h+1]);Be(e,n[p]),o[p++]=e}for(;u<=l;){const e=a[u++];null!==e&&He(e)}ze.set(i,o),Ge.set(i,m)}},(...e)=>{const i=Le(...e);return y.set(i,!0),i});var Le,Fe;!function(e){e[e.width=103]="width",e[e.height=160]="height"}(Fe||(Fe={}));var Ve=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ye=class extends ae{constructor(){super(...arguments),this.timer=0}static get styles(){return te``}firstUpdated(){this.image=this.images[0]}render(){return H`
      <div
        class="image"
    ...
    `}startCycler(){this.images.length<2||(clearInterval(this.timer),this.timer=window.setInterval(()=>{const e=this.images.findIndex(e=>e===this.image),i=e+1>=this.images.length?0:e+1,t=this.images[i];this.image=t},1e3))}stopCycler(){clearInterval(this.timer)}};Ve([Z({type:Array})],Ye.prototype,"images",void 0),Ve([Z({type:String})],Ye.prototype,"alt",void 0),Ve([Z({type:String})],Ye.prototype,"image",void 0),Ve([Z({type:Number})],Ye.prototype,"timer",void 0),Ye=Ve([X("glk-image-cycler")],Ye);var Je=t(1),We=t(10),Xe=te`
  .glk-control {
    display: flex;
...
`,Ze=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};function Qe(e){const i=We.find(i=>i.id===e);return i?i.name:"(Unknown)"}let ei=class extends ae{constructor(){super(...arguments),this.noDeck=!1,this.characters=[],this.deckId="",this.deckName="",this.deckCharacterIds=[],this.search="",this.showOnlySelected=!1,this.feedback=""}static get styles(){return[qe,Xe,...we,te`
        .decks__title {
          font-size: 1.5rem;
          margin: 1rem 0;
        }
      ...
      `]}firstUpdated(){this.unsub=de.subscribe(()=>this.initDeckBuilder()),this.initDeckBuilder(),this.characters=Je.map(e=>({...e,seriesName:Qe(e.seriesId)}))}disconnectedCallback(){this.unsub&&this.unsub()}render(){const e=this.search.toLowerCase(),i=this.characters.filter(i=>(i.name.toLowerCase().includes(e)||i.seriesName.toLowerCase().includes(e))&&(!this.showOnlySelected||this.showOnlySelected&&this.deckCharacterIds.includes(i.id)));return this.noDeck?H`
        <div>
          <h2>We couldn't find what you were looking for.</h2>
          <div>
            <glk-router-link .href=${de.base}
      ...
      <div class="decks">
        ...
        <div class="view">
          ...
          <ul class="grid grid--standard">
            ${Ue(i,e=>e.id,e=>{const i=Ke()(`${e.name}_${e.id}`),t=[e.image,...e.images.map(e=>e.url)],s=this.deckCharacterIds.includes(e.id);return H`
                  <li
                    key=${e.id}
                    class=${re("character-item",s&&"character-item--selected")}
                  >
                    <glk-image-cycler
                      .images=${t}
                      .alt=${e.name}
    ...
    `}initDeckBuilder(){const e=Pe.getKey("decks"),i=window.location.search,t=$e()(i).deck;if(!t)return;const s=e.find(e=>e.id===t);s?(this.deckId=t,this.deckName=s.name,this.deckCharacterIds=s.characterIds):this.noDeck=!0}onToggle(e){const i=e.target;this.showOnlySelected=i.checked}onUserInput(e){const i=e.target;this[i.name]=i.value}onToggleCharacter(e){const i=new Set(this.deckCharacterIds);i.delete(e)||i.add(e),this.deckCharacterIds=Array.from(i)}dropDeck(){let e=Pe.getKey("decks");e=e.filter(e=>e.id!==this.deckId),Pe.set({decks:e}),de.push("/decks")}validateForm(){const e=[];return this.deckName&&this.deckName.trim()||e.push("Deck name is required."),this.deckCharacterIds.length||e.push("Deck requires at least one character."),{success:0===e.length,errorMessages:e}}handleSave(){const e=this.validateForm();if(!e.success)return void(this.feedback=e.errorMessages.join("\n"));this.feedback="";const i=!this.deckId,t=this.deckId||Te()(),s={characterIds:this.deckCharacterIds,id:t,name:this.deckName};let a=Pe.getKey("decks");a=i?[...a,s]:a.map(e=>e.id===t?s:e),Pe.set({decks:a}),i&&de.push(`/decks-builder?deck=${t}`)}onDone(){de.push("/decks")}};Ze([Z({type:Boolean})],ei.prototype,"noDeck",void 0),Ze([Z({type:Array})],ei.prototype,"characters",void 0),Ze([Z({type:String})],ei.prototype,"deckId",void 0),Ze([Z({type:String})],ei.prototype,"deckName",void 0),Ze([Z({type:Array})],ei.prototype,"deckCharacterIds",void 0),Ze([Z({type:String})],ei.prototype,"search",void 0),Ze([Z({type:Boolean})],ei.prototype,"showOnlySelected",void 0),Ze([Z({type:String})],ei.prototype,"feedback",void 0),Ze([Z({type:Function})],ei.prototype,"unsub",void 0),ei=Ze([X("glk-decks-builder")],ei);var ii=te`
  /* Shared sizing */
  :host,
  .card,
  .card__axis,
...
`,ti=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let si=class extends ae{constructor(){super(...arguments),this.image=""}static get styles(){return te`
      :host {
        position: absolute;
        top: 0;
        left: 0;
    ...
    `}};ti([Z({type:String})],si.prototype,"image",void 0),si=ti([X("glk-card-back")],si);var ai=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let ri=class extends ae{constructor(){super(...arguments),this.isFaceUp=!1,this.isHidden=!1,this.shouldHide=!0,this.cardId="",this.name="",this.image="",this.width=Fe.width,this.height=Fe.height,this.cardBack=""}static get styles(){return ii}firstUpdated(){const e=_e.get();this.shouldHide=e.hideOnMatch}render(){const e=this.isHidden&&this.shouldHide,i=this.isHidden&&!this.shouldHide;if(e)return H``;const t=this.isFaceUp||i,s=this.image?this.image.slice(0).replace(/\.jpg/,"t.jpg"):null;return H`
      <button
        type="button"
    ...
    `}handleClick(){const e=new CustomEvent("flipped",{bubbles:!0,composed:!0,detail:{cardId:this.cardId}});this.dispatchEvent(e)}};ai([Z({type:Boolean})],ri.prototype,"isFaceUp",void 0),ai([Z({type:Boolean})],ri.prototype,"isHidden",void 0),ai([Z({type:Boolean})],ri.prototype,"shouldHide",void 0),ai([Z({type:String})],ri.prototype,"cardId",void 0),ai([Z({type:String})],ri.prototype,"name",void 0),ai([Z({type:String})],ri.prototype,"image",void 0),ai([Z({type:Number})],ri.prototype,"width",void 0),ai([Z({type:Number})],ri.prototype,"height",void 0),ai([Z({type:String})],ri.prototype,"cardBack",void 0),ri=ai([X("glk-card")],ri);var oi=te`
  @keyframes growth {
    0% {
      transform: scale(0);
      opacity: 0;
...
`;const ni="#fdd87f",mi="#999900",di="#51c2ea",ci="#2a87ca";function gi(e){return function(e){const i=document.createElement("div");return i.innerHTML=function(e){const{strings:i,values:t}=e,s=i.length;let a="";for(let e=0;e<s;e++)a+=i[e]+(t[e]||"");return a}(e),"data:image/svg+xml;base64,"+window.btoa(i.innerHTML)}(function(e){switch(e){case Ie.argyle:return H`
      ...
      `;case Ie.blueprint:return H`
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30">
          <rect width="30" height="30" fill=${ni} />
          <g fill=${ci}>
      ...
      `;case Ie.subtleDots:default:return H`
        <svg xmlns="http://www.w3.org/2000/svg" width="5" height="5">
          <rect width="5" height="5" fill=${ni} />
          <rect width="1" height="1" fill=${di} />
        </svg>
      `}}(e))}var ui=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let li=class extends ae{constructor(){super(...arguments),this.cards=[],this.selected=[],this.removed=[],this.hasMatch=!1,this.cardBack=""}static get styles(){return[te`
        :host {
          display: grid;
        ...
        ${be(pe.XXS,te`
          ...
          `)}
      `,oi]}firstUpdated(){const e=_e.get();this.cardBack=gi(e.cardBack)}render(){const e=2===this.selected.length;return H`
      ${e?H`
            <style>
          ...
          `:""}
      ${this.cards.map(e=>{const i=this.removed.includes(e.id),t=this.selected.includes(e.id),s=[t?"glk-card--flipped":"",t&&this.hasMatch?"glk-card--matched":""].join(" ");return H`
          <glk-card
            class="${s}"
            cardId=${e.id}
            name=${e.name}
          ...
          ></glk-card>
        `})}
    `}};ui([Z({type:Array})],li.prototype,"cards",void 0),ui([Z({type:Array})],li.prototype,"selected",void 0),ui([Z({type:Array})],li.prototype,"removed",void 0),ui([Z({type:Boolean})],li.prototype,"hasMatch",void 0),ui([Z({type:String})],li.prototype,"cardBack",void 0),li=ui([X("glk-card-grid")],li);var pi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let hi=class extends ae{constructor(){super(...arguments),this.streak=0,this.uppedStreak=!1,this.timer=0}static get styles(){return te`
      :host {
        padding: 5px;
      }
    ...
    `}updated(e){const i=e.has("streak"),t=e.get("streak")||0;i&&this.streak>t&&(this.uppedStreak=!0,this.setPulse())}render(){const e=this.streak>0,i=`${this.streak}x streak`;return H`
    ...
    `}setPulse(){clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.uppedStreak=!1},1250)}};pi([Z({type:Number})],hi.prototype,"streak",void 0),pi([Z({type:Boolean})],hi.prototype,"uppedStreak",void 0),pi([Z({type:Number})],hi.prototype,"timer",void 0),hi=pi([X("glk-streak")],hi);var fi=t(3),yi=t.n(fi);function ki(e){const i=[e.image,...e.images.map(e=>e.url)];return yi()(i).pop()}const vi=e=>({characterId:e.id,id:Te()(),image:e.image,name:e.name});var bi=t(0),ji=t.n(bi);var Ii=new class{constructor(){this.interval=0,this.paused=!0,this.gameTime=0,this.callback=()=>null}get time(){return this.formatTime(this.gameTime)}get isPaused(){return this.paused}formatTime(e){const i=Math.floor(e/60),t=e%60;return`${ji()(i,2)}m ${ji()(t,2)}s`}subscribe(e){return this.callback=e,this.reset(),this.start(),()=>{const e=this.gameTime;return this.callback=()=>null,this.reset(),e}}start(){this.paused=!1,clearInterval(this.interval),this.interval=window.setInterval(()=>{this.gameTime+=1,this.callback(this.time)},1e3)}stop(){this.paused=!0,clearInterval(this.interval)}reset(){this.stop(),this.gameTime=0}},wi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};const Si=te`
  .game-bar {
...
`;let xi=class extends ae{constructor(){super(...arguments),this.turns=[],this.timer=0,this.inGame=!1,this.timeElapsed="00m 00s",this.gameSummary=[],this.hasMatch=!1,this.pairs=[],this.choices=[],this.cards=[],this.unsubTimer=()=>0}static get styles(){return te`
      :host {
      ...
      ${be(pe.XS,Si)}
      ${be(pe.XXS,Si)}
    `}render(){const e=this.pairs.length,i=e?e/2:0,t=this.gameSummary.length>0,s=this.getCurrentStreak(),a=e=>H`
      <div class="${e}">
    ...
    `}newGame(){this.gameSummary=[],this.turns=[],this.choices=[],this.cards=function(){const e=Pe.getKey("decks"),i=_e.get();let t=Je;const s=e.find(e=>e.id===i.deckId);s&&(t=Je.filter(e=>s.characterIds.includes(e.id)));const a=yi()(t).slice(0,i.startingPairs).map(e=>({...e,image:ki(e)})),r=[...a,...a];return yi()(r).map(vi)}(),this.inGame=!0,this.unsubTimer=Ii.subscribe(e=>this.timeElapsed=e)}endGame(e=!1){const i=this.unsubTimer(),t=this.pairs.length/2,s=this.turns.length,a=this.getLongestStreak();if(this.inGame=!1,this.pairs=[],this.turns=[],this.choices=this.cards.map(e=>e.id),this.gameSummary=[e?"You found all the pairs!":"Quitters always quit.",`${t} pairs found in ${Ii.formatTime(i)}`,`${a} was your longest match streak`],e){const e=Pe.getKey("history");Pe.set({history:[...e,{datetime:(new Date).getTime(),longestStreak:a,pairs:t,timeElapsed:i,turns:s}]})}}onCardFlip(e){if(2===this.choices.length)return;const i=e.detail;!this.choices.includes(i.cardId)&&(this.choices=[...this.choices,i.cardId],this.checkCards())}checkCards(){if(2!==this.choices.length)return;const e=this.choices.map(e=>{const i=this.cards.find(i=>i.id===e);if(i)return i.characterId}),i=this.turns.slice(0),t=1===new Set(e).size;this.hasMatch=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{t&&(this.pairs=[...this.pairs,...this.choices]),this.turns=[...i,{number:i.length+1,isMatch:t}],this.choices=[],this.hasMatch=!1,this.checkGameState()},1500)}checkGameState(){this.cards.length===this.pairs.length&&0!==this.pairs.length&&this.endGame(!0)}getCurrentStreak(){return this.turns.slice(0).reverse().reduce((e,i)=>{const t=e.isBroken||!i.isMatch;return{streak:t?e.streak:e.streak+1,isBroken:t}},{streak:0,isBroken:!1}).streak}getLongestStreak(){return this.turns.slice(0).reduce((e,i)=>{const t=i.isMatch?e.streak+1:0;return{streak:t,longest:t>e.longest?t:e.longest}},{longest:0,streak:0}).longest}};wi([Z({type:Array})],xi.prototype,"turns",void 0),wi([Z({type:Number})],xi.prototype,"timer",void 0),wi([Z({type:Boolean})],xi.prototype,"inGame",void 0),wi([Z({type:String})],xi.prototype,"timeElapsed",void 0),wi([Z({type:Array})],xi.prototype,"gameSummary",void 0),wi([Z({type:Boolean})],xi.prototype,"hasMatch",void 0),wi([Z({type:Array})],xi.prototype,"pairs",void 0),wi([Z({type:Array})],xi.prototype,"choices",void 0),wi([Z({type:Array})],xi.prototype,"cards",void 0),wi([Z({type:Function})],xi.prototype,"unsubTimer",void 0),xi=wi([X("glk-home")],xi);var _i=t(11),Pi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};const Oi=Object.keys(Ie);let Mi=class extends ae{constructor(){super(...arguments),this.decks=[],this.startingPairs=0,this.cardBack=Ie.subtleDots,this.deckId="",this.hideOnMatch=!0}static get styles(){return[qe,Xe,te`
        :host {
          margin: 10px;
        }
      ...
      `]}firstUpdated(){const e=_e.get();this.decks=Pe.getKey("decks"),this.startingPairs=e.startingPairs,this.cardBack=e.cardBack,this.hideOnMatch=e.hideOnMatch,this.deckId=e.deckId}render(){const e=this.isValidForm(),i=e.success,t=e.messages;return H`
      <div class="options">
            ...
            >
              ${Oi.map(e=>H`
                  <option value=${e} ?selected=${e===this.cardBack}
                    >${Object(_i.separateAndCapitalise)(e)}</option
                  >
                `)}
            </select>
          </div>
    ...
    `}onUserInput(e){const i=e.target,t=Number(i.value);this.startingPairs=t}onSelect(e){const i=e.target,t=i.name;"cardBack"===t?this.cardBack=i.value:"deckId"===t&&(this.deckId=i.value)}onToggle(e){const i=e.target;this.hideOnMatch=i.checked}isValidForm(){const e=[],i=this.startingPairs>=1&&this.startingPairs<=26;i||e.push("Starting pairs must be 1 <= n <= 26");const t=this.decks.find(e=>e.id===this.deckId),s=!t||t.characterIds.length>=this.startingPairs;return s||e.push("The deck chosen has fewer characters than the number of pairs requested."),{messages:e.join("\r\n"),success:i&&s}}handleSave(e){e.preventDefault(),this.isValidForm().success&&(_e.set({cardBack:this.cardBack,deckId:this.deckId,hideOnMatch:this.hideOnMatch,startingPairs:this.startingPairs}),de.push("/"))}};Pi([Z({type:Array})],Mi.prototype,"decks",void 0),Pi([Z({type:Number})],Mi.prototype,"startingPairs",void 0),Pi([Z({type:String})],Mi.prototype,"cardBack",void 0),Pi([Z({type:String})],Mi.prototype,"deckId",void 0),Pi([Z({type:Boolean})],Mi.prototype,"hideOnMatch",void 0),Mi=Pi([X("glk-options")],Mi);var Ai=t(12),$i=t.n(Ai),Ni=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ti=class extends ae{constructor(){super(...arguments),this.show=!1,this.direction=0}static get styles(){return te`
      .icon {
        display: inline-block;
        margin: 0 5px;
      }
    `}render(){if(!this.direction||!this.show)return H``;const e=1===this.direction?"▲︎":"▼︎";return H`
      <span class="icon">${e}</span>
    `}};Ni([Z({type:Boolean})],Ti.prototype,"show",void 0),Ni([Z({type:Number})],Ti.prototype,"direction",void 0),Ti=Ni([X("glk-sort-icon")],Ti);var Ci=t(13),Ki=t.n(Ci);const Ri=new Map([["timeElapsed",{props:["timeElapsed","pairs"],orders:e=>e>0?["asc","desc"]:["desc","asc"]}],["datetime",{props:["datetime"],orders:e=>e>0?["asc"]:["desc"]}],["pairs",{props:["pairs","timeElapsed"],orders:e=>e>0?["asc","asc"]:["desc","desc"]}],["longestStreak",{props:["longestStreak","pairs","timeElapsed"],orders:e=>e>0?["asc","desc","desc"]:["desc","asc","asc"]}],["matchAttemptsRatio",{props:["matchAttemptsRatio","timeElapsed","longestStreak"],orders:e=>e>0?["asc","desc","asc"]:["desc","asc","desc"]}]]);var Bi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Di=class extends ae{constructor(){super(...arguments),this.sortField="matchAttemptsRatio",this.sortOrder=-1,this.history=[]}static get styles(){return[te`
        :host {
          margin: 10px;
        }
        ...
        ${be(pe.XXS,te`
          ...
          `)}
      `]}firstUpdated(){const e=Pe.getKey("history");this.history=e.map(e=>({...e,date:$i()(e.datetime),matchAttemptsRatio:0!==e.turns?e.pairs/e.turns:0,timeElapsedDisplay:Ii.formatTime(e.timeElapsed)}))}render(){const e=function(e,i,t){const s=Ri.get(i);return Ki()(e,s.props,s.orders(t))}(this.history,this.sortField,this.sortOrder);return H`
    ...
    `}itemNumber(e){return`#${ji()(e+1,3)}`}handleSort(e){this.sortField===e&&(this.sortOrder=1===this.sortOrder?-1:1),this.sortField=e}};Bi([Z({type:Array})],Di.prototype,"sortField",void 0),Bi([Z({type:Array})],Di.prototype,"sortOrder",void 0),Bi([Z({type:Array})],Di.prototype,"history",void 0),Di=Bi([X("glk-scores")],Di);var Hi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ei=class extends ae{constructor(){super(...arguments),this.routeKey=""}firstUpdated(){de.subscribe(({key:e})=>this.routeKey=e)}render(){let e=de.currentRoute;return e||(e={name:"404",render:()=>H`
          <h2>We couldn't find what you were looking for.</h2>
          <div>
            <glk-router-link .href=${de.base}
              >Return to Home</glk-router-link
        ...
        `,url:""}),e.render(this.routeKey)}};Hi([Z({type:String})],Ei.prototype,"routeKey",void 0),Ei=Hi([X("glk-router-view")],Ei);var zi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Gi=class extends ae{constructor(){super(...arguments),this.text="",this.delay=750,this.allowWrapping=!1,this.usePosition=!1,this.timer=0,this.isHovered=!1,this.at=[]}static get styles(){return te`
      .tooltip {
        position: relative;
      }
      .tooltip__content {
    ...
    `}render(){const[e,i,t]=this.at,s=t?{transform:`translateX(${t}px)`}:{},a=this.usePosition?{top:i,left:e,bottom:"unset",...s}:{...s},r=(o=a,Object.keys(o).reduce((e,i)=>`${e}${i}: ${o[i]};`,""));var o;return H`
      <div
        class=${re("tooltip",this.isHovered&&"tooltip--hovered")}
        @mouseenter=${this.handleEnter}
        @mouseleave=${this.handleLeave}
      >
        <div
          style="${r}"
          class=${re("tooltip__content",this.allowWrapping&&"tooltip__content--wrap",this.usePosition&&"tooltip__content--fixed")}
        >
          ${this.text}
        </div>
        <slot></slot>
      </div>
    `}handleEnter(e){const{clientX:i,clientY:t}=e,s=this.shadowRoot.querySelector(".tooltip");let a=0;if(s&&s.firstChild){const e=s.getBoundingClientRect(),i=s.firstChild.offsetWidth,t=window.innerWidth-(e.width+e.left);i>e.left+e.width/2?a=-e.left:t<i&&(a=-(i-t))}clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.isHovered=!0,this.at=[i,t,a]},this.delay)}handleLeave(){clearTimeout(this.timer),this.isHovered=!1,this.at=[]}};zi([Z({type:String})],Gi.prototype,"text",void 0),zi([Z({type:Number})],Gi.prototype,"delay",void 0),zi([Z({type:Boolean})],Gi.prototype,"allowWrapping",void 0),zi([Z({type:Boolean})],Gi.prototype,"usePosition",void 0),zi([Z({type:Number})],Gi.prototype,"timer",void 0),zi([Z({type:Boolean})],Gi.prototype,"isHovered",void 0),zi([Z({type:Array})],Gi.prototype,"at",void 0),Gi=zi([X("glk-tooltip")],Gi);var Ui=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/galko/sw.js").then(e=>console.log("SW registered: ",e)).catch(e=>console.log("SW registration failed: ",e))});let Li=class extends ae{static get styles(){return te`
      :host,
      main {
    ...
    `}render(){const e=de.base;return H`
      <main>
