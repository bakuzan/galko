 ...
 */
const s=new WeakMap,a=e=>"function"==typeof e&&s.has(e),r=void 0!==window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,o=(e,i,t=null,s=null)=>{for(;i!==t;){const t=i.nextSibling;e.insertBefore(i,s),i=t}},n=(e,i,t=null)=>{for(;i!==t;){const t=i.nextSibling;e.removeChild(i),i=t}},m={},d={},c=`{{lit-${String(Math.random()).slice(2)}}}`,g=`\x3c!--${c}--\x3e`,l=new RegExp(`${c}|${g}`),u="$lit$";class p{constructor(e,i){this.parts=[],this.element=i;const t=[],s=[],a=document.createTreeWalker(i.content,133,null,!1);let r=0,o=-1,n=0;const{strings:m,values:{length:d}}=e;for(;n<d;){const e=a.nextNode();if(null!==e){if(o++,1===e.nodeType){if(e.hasAttributes()){const i=e.attributes,{length:t}=i;let s=0;for(let e=0;e<t;e++)h(i[e].name,u)&&s++;for(;s-- >0;){const i=m[n],t=k.exec(i)[2],s=t.toLowerCase()+u,a=e.getAttribute(s);e.removeAttribute(s);const r=a.split(l);this.parts.push({type:"attribute",index:o,name:t,strings:r}),n+=r.length-1}}"TEMPLATE"===e.tagName&&(s.push(e),a.currentNode=e.content)}else if(3===e.nodeType){const i=e.data;if(i.indexOf(c)>=0){const s=e.parentNode,a=i.split(l),r=a.length-1;for(let i=0;i<r;i++){let t,r=a[i];if(""===r)t=y();else{const e=k.exec(r);null!==e&&h(e[2],u)&&(r=r.slice(0,e.index)+e[1]+e[2].slice(0,-u.length)+e[3]),t=document.createTextNode(r)}s.insertBefore(t,e),this.parts.push({type:"node",index:++o})}""===a[r]?(s.insertBefore(y(),e),t.push(e)):e.data=a[r],n+=r}}else if(8===e.nodeType)if(e.data===c){const i=e.parentNode;null!==e.previousSibling&&o!==r||(o++,i.insertBefore(y(),e)),r=o,this.parts.push({type:"node",index:o}),null===e.nextSibling?e.data="":(t.push(e),o--),n++}else{let i=-1;for(;-1!==(i=e.data.indexOf(c,i+1));)this.parts.push({type:"node",index:-1}),n++}}else a.currentNode=s.pop()}for(const e of t)e.parentNode.removeChild(e)}}const h=(e,i)=>{const t=e.length-i.length;return t>=0&&e.slice(t)===i},f=e=>-1!==e.index,y=()=>document.createComment(""),k=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class v{constructor(e,i,t){this.__parts=[],this.template=e,this.processor=i,this.options=t}update(e){let i=0;for(const t of this.__parts)void 0!==t&&t.setValue(e[i]),i++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=r?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),i=[],t=this.template.parts,s=document.createTreeWalker(e,133,null,!1);let a,o=0,n=0,m=s.nextNode();for(;o<t.length;)if(a=t[o],f(a)){for(;n<a.index;)n++,"TEMPLATE"===m.nodeName&&(i.push(m),s.currentNode=m.content),null===(m=s.nextNode())&&(s.currentNode=i.pop(),m=s.nextNode());if("node"===a.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(m.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(m,a.name,a.strings,this.options));o++}else this.__parts.push(void 0),o++;return r&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */class b{constructor(e,i,t,s){this.strings=e,this.values=i,this.type=t,this.processor=s}getHTML(){const e=this.strings.length-1;let i="",t=!1;for(let s=0;s<e;s++){const e=this.strings[s],a=e.lastIndexOf("\x3c!--");t=(a>-1||t)&&-1===e.indexOf("--\x3e",a+1);const r=k.exec(e);i+=null===r?e+(t?c:g):e.substr(0,r.index)+r[1]+r[2]+u+r[3]+c}return i+=this.strings[e],i}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const j=e=>null===e||!("object"==typeof e||"function"==typeof e),I=e=>Array.isArray(e)||!(!e||!e[Symbol.iterator]);class w{constructor(e,i,t){this.dirty=!0,this.element=e,this.name=i,this.strings=t,this.parts=[];for(let e=0;e<t.length-1;e++)this.parts[e]=this._createPart()}_createPart(){return new S(this)}_getValue(){const e=this.strings,i=e.length-1;let t="";for(let s=0;s<i;s++){t+=e[s];const i=this.parts[s];if(void 0!==i){const e=i.value;if(j(e)||!I(e))t+="string"==typeof e?e:String(e);else for(const i of e)t+="string"==typeof i?i:String(i)}}return t+=e[i],t}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class S{constructor(e){this.value=void 0,this.committer=e}setValue(e){e===m||j(e)&&e===this.value||(this.value=e,a(e)||(this.committer.dirty=!0))}commit(){for(;a(this.value);){const e=this.value;this.value=m,e(this)}this.value!==m&&this.committer.commit()}}class x{constructor(e){this.value=void 0,this.__pendingValue=void 0,this.options=e}appendInto(e){this.startNode=e.appendChild(y()),this.endNode=e.appendChild(y())}insertAfterNode(e){this.startNode=e,this.endNode=e.nextSibling}appendIntoPart(e){e.__insert(this.startNode=y()),e.__insert(this.endNode=y())}insertAfterPart(e){e.__insert(this.startNode=y()),this.endNode=e.endNode,e.endNode=this.startNode}setValue(e){this.__pendingValue=e}commit(){for(;a(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=m,e(this)}const e=this.__pendingValue;e!==m&&(j(e)?e!==this.value&&this.__commitText(e):e instanceof b?this.__commitTemplateResult(e):e instanceof Node?this.__commitNode(e):I(e)?this.__commitIterable(e):e===d?(this.value=d,this.clear()):this.__commitText(e))}__insert(e){this.endNode.parentNode.insertBefore(e,this.endNode)}__commitNode(e){this.value!==e&&(this.clear(),this.__insert(e),this.value=e)}__commitText(e){const i=this.startNode.nextSibling,t="string"==typeof(e=null==e?"":e)?e:String(e);i===this.endNode.previousSibling&&3===i.nodeType?i.data=t:this.__commitNode(document.createTextNode(t)),this.value=e}__commitTemplateResult(e){const i=this.options.templateFactory(e);if(this.value instanceof v&&this.value.template===i)this.value.update(e.values);else{const t=new v(i,e.processor,this.options),s=t._clone();t.update(e.values),this.__commitNode(s),this.value=t}}__commitIterable(e){Array.isArray(this.value)||(this.value=[],this.clear());const i=this.value;let t,s=0;for(const a of e)t=i[s],void 0===t&&(t=new x(this.options),i.push(t),0===s?t.appendIntoPart(this):t.insertAfterPart(i[s-1])),t.setValue(a),t.commit(),s++;s<i.length&&(i.length=s,this.clear(t&&t.endNode))}clear(e=this.startNode){n(this.startNode.parentNode,e.nextSibling,this.endNode)}}class _{constructor(e,i,t){if(this.value=void 0,this.__pendingValue=void 0,2!==t.length||""!==t[0]||""!==t[1])throw new Error("Boolean attributes can only contain a single expression");this.element=e,this.name=i,this.strings=t}setValue(e){this.__pendingValue=e}commit(){for(;a(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=m,e(this)}if(this.__pendingValue===m)return;const e=!!this.__pendingValue;this.value!==e&&(e?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=e),this.__pendingValue=m}}class P extends w{constructor(e,i,t){super(e,i,t),this.single=2===t.length&&""===t[0]&&""===t[1]}_createPart(){return new O(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class O extends S{}let M=!1;try{const e={get capture(){return M=!0,!1}};window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){}class A{constructor(e,i,t){this.value=void 0,this.__pendingValue=void 0,this.element=e,this.eventName=i,this.eventContext=t,this.__boundHandleEvent=e=>this.handleEvent(e)}setValue(e){this.__pendingValue=e}commit(){for(;a(this.__pendingValue);){const e=this.__pendingValue;this.__pendingValue=m,e(this)}if(this.__pendingValue===m)return;const e=this.__pendingValue,i=this.value,t=null==e||null!=i&&(e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive),s=null!=e&&(null==i||t);t&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),s&&(this.__options=C(e),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=e,this.__pendingValue=m}handleEvent(e){"function"==typeof this.value?this.value.call(this.eventContext||this.element,e):this.value.handleEvent(e)}}const C=e=>e&&(M?{capture:e.capture,passive:e.passive,once:e.once}:e.capture);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const T=new class{handleAttributeExpressions(e,i,t,s){const a=i[0];if("."===a){return new P(e,i.slice(1),t).parts}return"@"===a?[new A(e,i.slice(1),s.eventContext)]:"?"===a?[new _(e,i.slice(1),t)]:new w(e,i,t).parts}handleTextExpression(e){return new x(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function N(e){let i=$.get(e.type);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},$.set(e.type,i));let t=i.stringsArray.get(e.strings);if(void 0!==t)return t;const s=e.strings.join(c);return t=i.keyString.get(s),void 0===t&&(t=new p(e,e.getTemplateElement()),i.keyString.set(s,t)),i.stringsArray.set(e.strings,t),t}const $=new Map,K=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.1");const R=(e,...i)=>new b(e,i,"html",T),B=133;function H(e,i){const{element:{content:t},parts:s}=e,a=document.createTreeWalker(t,B,null,!1);let r=D(s),o=s[r],n=-1,m=0;const d=[];let c=null;for(;a.nextNode();){n++;const e=a.currentNode;for(e.previousSibling===c&&(c=null),i.has(e)&&(d.push(e),null===c&&(c=e)),null!==c&&m++;void 0!==o&&o.index===n;)o.index=null!==c?-1:o.index-m,r=D(s,r),o=s[r]}d.forEach(e=>e.parentNode.removeChild(e))}const E=e=>{let i=11===e.nodeType?0:1;const t=document.createTreeWalker(e,B,null,!1);for(;t.nextNode();)i++;return i},D=(e,i=-1)=>{for(let t=i+1;t<e.length;t++){const i=e[t];if(f(i))return t}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const z=(e,i)=>`${e}--${i}`;let G=!0;void 0===window.ShadyCSS?G=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),G=!1);const L=e=>i=>{const t=z(i.type,e);let s=$.get(t);void 0===s&&(s={stringsArray:new WeakMap,keyString:new Map},$.set(t,s));let a=s.stringsArray.get(i.strings);if(void 0!==a)return a;const r=i.strings.join(c);if(a=s.keyString.get(r),void 0===a){const t=i.getTemplateElement();G&&window.ShadyCSS.prepareTemplateDom(t,e),a=new p(i,t),s.keyString.set(r,a)}return s.stringsArray.set(i.strings,a),a},U=["html","svg"],F=new Set,V=(e,i,t)=>{F.add(e);const s=t?t.element:document.createElement("template"),a=i.querySelectorAll("style"),{length:r}=a;if(0===r)return void window.ShadyCSS.prepareTemplateStyles(s,e);const o=document.createElement("style");for(let e=0;e<r;e++){const i=a[e];i.parentNode.removeChild(i),o.textContent+=i.textContent}(e=>{U.forEach(i=>{const t=$.get(z(i,e));void 0!==t&&t.keyString.forEach(e=>{const{element:{content:i}}=e,t=new Set;Array.from(i.querySelectorAll("style")).forEach(e=>{t.add(e)}),H(e,t)})})})(e);const n=s.content;t?function(e,i,t=null){const{element:{content:s},parts:a}=e;if(null==t)return void s.appendChild(i);const r=document.createTreeWalker(s,B,null,!1);let o=D(a),n=0,m=-1;for(;r.nextNode();){for(m++,r.currentNode===t&&(n=E(i),t.parentNode.insertBefore(i,t));-1!==o&&a[o].index===m;){if(n>0){for(;-1!==o;)a[o].index+=n,o=D(a,o);return}o=D(a,o)}}}(t,o,n.firstChild):n.insertBefore(o,n.firstChild),window.ShadyCSS.prepareTemplateStyles(s,e);const m=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==m)i.insertBefore(m.cloneNode(!0),i.firstChild);else if(t){n.insertBefore(o,n.firstChild);const e=new Set;e.add(o),H(t,e)}};window.JSCompiler_renameProperty=(e,i)=>e;const Y={toAttribute(e,i){switch(i){case Boolean:return e?"":null;case Object:case Array:return null==e?e:JSON.stringify(e)}return e},fromAttribute(e,i){switch(i){case Boolean:return null!==e;case Number:return null===e?null:Number(e);case Object:case Array:return JSON.parse(e)}return e}},J=(e,i)=>i!==e&&(i==i||e==e),W={attribute:!0,type:String,converter:Y,reflect:!1,hasChanged:J},X=Promise.resolve(!0),q=1,Z=4,Q=8,ee=16,ie=32,te="finalized";class se extends HTMLElement{constructor(){super(),this._updateState=0,this._instanceProperties=void 0,this._updatePromise=X,this._hasConnectedResolver=void 0,this._changedProperties=new Map,this._reflectingProperties=void 0,this.initialize()}static get observedAttributes(){this.finalize();const e=[];return this._classProperties.forEach((i,t)=>{const s=this._attributeNameForProperty(t,i);void 0!==s&&(this._attributeToPropertyMap.set(s,t),e.push(s))}),e}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const e=Object.getPrototypeOf(this)._classProperties;void 0!==e&&e.forEach((e,i)=>this._classProperties.set(i,e))}}static createProperty(e,i=W){if(this._ensureClassProperties(),this._classProperties.set(e,i),i.noAccessor||this.prototype.hasOwnProperty(e))return;const t="symbol"==typeof e?Symbol():`__${e}`;Object.defineProperty(this.prototype,e,{get(){return this[t]},set(i){const s=this[e];this[t]=i,this._requestUpdate(e,s)},configurable:!0,enumerable:!0})}static finalize(){const e=Object.getPrototypeOf(this);if(e.hasOwnProperty(te)||e.finalize(),this[te]=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const e=this.properties,i=[...Object.getOwnPropertyNames(e),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(e):[]];for(const t of i)this.createProperty(t,e[t])}}static _attributeNameForProperty(e,i){const t=i.attribute;return!1===t?void 0:"string"==typeof t?t:"string"==typeof e?e.toLowerCase():void 0}static _valueHasChanged(e,i,t=J){return t(e,i)}static _propertyValueFromAttribute(e,i){const t=i.type,s=i.converter||Y,a="function"==typeof s?s:s.fromAttribute;return a?a(e,t):e}static _propertyValueToAttribute(e,i){if(void 0===i.reflect)return;const t=i.type,s=i.converter;return(s&&s.toAttribute||Y.toAttribute)(e,t)}initialize(){this._saveInstanceProperties(),this._requestUpdate()}_saveInstanceProperties(){this.constructor._classProperties.forEach((e,i)=>{if(this.hasOwnProperty(i)){const e=this[i];delete this[i],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(i,e)}})}_applyInstanceProperties(){this._instanceProperties.forEach((e,i)=>this[i]=e),this._instanceProperties=void 0}connectedCallback(){this._updateState=this._updateState|ie,this._hasConnectedResolver&&(this._hasConnectedResolver(),this._hasConnectedResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(e,i,t){i!==t&&this._attributeToProperty(e,t)}_propertyToAttribute(e,i,t=W){const s=this.constructor,a=s._attributeNameForProperty(e,t);if(void 0!==a){const e=s._propertyValueToAttribute(i,t);if(void 0===e)return;this._updateState=this._updateState|Q,null==e?this.removeAttribute(a):this.setAttribute(a,e),this._updateState=this._updateState&~Q}}_attributeToProperty(e,i){if(this._updateState&Q)return;const t=this.constructor,s=t._attributeToPropertyMap.get(e);if(void 0!==s){const e=t._classProperties.get(s)||W;this._updateState=this._updateState|ee,this[s]=t._propertyValueFromAttribute(i,e),this._updateState=this._updateState&~ee}}_requestUpdate(e,i){let t=!0;if(void 0!==e){const s=this.constructor,a=s._classProperties.get(e)||W;s._valueHasChanged(this[e],i,a.hasChanged)?(this._changedProperties.has(e)||this._changedProperties.set(e,i),!0!==a.reflect||this._updateState&ee||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(e,a))):t=!1}!this._hasRequestedUpdate&&t&&this._enqueueUpdate()}requestUpdate(e,i){return this._requestUpdate(e,i),this.updateComplete}async _enqueueUpdate(){let e,i;this._updateState=this._updateState|Z;const t=this._updatePromise;this._updatePromise=new Promise((t,s)=>{e=t,i=s});try{await t}catch(e){}this._hasConnected||await new Promise(e=>this._hasConnectedResolver=e);try{const e=this.performUpdate();null!=e&&await e}catch(e){i(e)}e(!this._hasRequestedUpdate)}get _hasConnected(){return this._updateState&ie}get _hasRequestedUpdate(){return this._updateState&Z}get hasUpdated(){return this._updateState&q}performUpdate(){this._instanceProperties&&this._applyInstanceProperties();let e=!1;const i=this._changedProperties;try{e=this.shouldUpdate(i),e&&this.update(i)}catch(i){throw e=!1,i}finally{this._markUpdated()}e&&(this._updateState&q||(this._updateState=this._updateState|q,this.firstUpdated(i)),this.updated(i))}_markUpdated(){this._changedProperties=new Map,this._updateState=this._updateState&~Z}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this._updatePromise}shouldUpdate(e){return!0}update(e){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((e,i)=>this._propertyToAttribute(i,this[i],e)),this._reflectingProperties=void 0)}updated(e){}firstUpdated(e){}}se[te]=!0;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ae=e=>i=>"function"==typeof i?((e,i)=>(window.customElements.define(e,i),i))(e,i):((e,i)=>{const{kind:t,elements:s}=i;return{kind:t,elements:s,finisher(i){window.customElements.define(e,i)}}})(e,i),re=(e,i)=>"method"!==i.kind||!i.descriptor||"value"in i.descriptor?{kind:"field",key:Symbol(),placement:"own",descriptor:{},initializer(){"function"==typeof i.initializer&&(this[i.key]=i.initializer.call(this))},finisher(t){t.createProperty(i.key,e)}}:Object.assign({},i,{finisher(t){t.createProperty(i.key,e)}}),oe=(e,i,t)=>{i.constructor.createProperty(t,e)};function ne(e){return(i,t)=>void 0!==t?oe(e,i,t):re(e,i)}const me="adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,de=Symbol();class ce{constructor(e,i){if(i!==de)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e}get styleSheet(){return void 0===this._styleSheet&&(me?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}}const ge=(e,...i)=>{const t=i.reduce((i,t,s)=>i+(e=>{if(e instanceof ce)return e.cssText;if("number"==typeof e)return e;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${e}. Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security.`)})(t)+e[s+1],e[0]);return new ce(t,de)};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.2.1");const le=e=>e.flat?e.flat(1/0):function e(i,t=[]){for(let s=0,a=i.length;s<a;s++){const a=i[s];Array.isArray(a)?e(a,t):t.push(a)}return t}(e);class ue extends se{static finalize(){super.finalize.call(this),this._styles=this.hasOwnProperty(JSCompiler_renameProperty("styles",this))?this._getUniqueStyles():this._styles||[]}static _getUniqueStyles(){const e=this.styles,i=[];if(Array.isArray(e)){le(e).reduceRight((e,i)=>(e.add(i),e),new Set).forEach(e=>i.unshift(e))}else e&&i.push(e);return i}initialize(){super.initialize(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?me?this.renderRoot.adoptedStyleSheets=e.map(e=>e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){super.update(e);const i=this.render();i instanceof b&&this.constructor.render(i,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const i=document.createElement("style");i.textContent=e.cssText,this.renderRoot.appendChild(i)}))}render(){}}function pe(...e){return e.filter(e=>!!e).join(" ")}ue.finalized=!0,ue.render=(e,i,t)=>{if(!t||"object"!=typeof t||!t.scopeName)throw new Error("The `scopeName` option is required.");const s=t.scopeName,a=K.has(i),r=G&&11===i.nodeType&&!!i.host,o=r&&!F.has(s),m=o?document.createDocumentFragment():i;if(((e,i,t)=>{let s=K.get(i);void 0===s&&(n(i,i.firstChild),K.set(i,s=new x(Object.assign({templateFactory:N},t))),s.appendInto(i)),s.setValue(e),s.commit()})(e,m,Object.assign({templateFactory:L(s)},t)),o){const e=K.get(m);K.delete(m);const t=e.value instanceof v?e.value.template:void 0;V(s,m,t),n(i,i.firstChild),i.appendChild(m),K.set(i,e)}!a&&r&&window.ShadyCSS.styleElement(i.host)};var he=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let fe=class extends ue{constructor(){super(...arguments),this.type="button",this.primary=!1,this.danger=!1,this.icon=!1,this.disabled=!1}static get styles(){return ge`
      :host[disabled] {
        pointer-events: none;
      }
    ...
    `}render(){const e=pe("button",this.primary&&"button--primary",this.icon&&"button--icon",this.danger&&"button--danger");return R`
      <button
        type="${this.type}"
        class="${e}"
    ...
    `}handleClick(){const e=new CustomEvent("press",{bubbles:!0,composed:!0,detail:null});this.dispatchEvent(e)}};he([ne({type:String})],fe.prototype,"type",void 0),he([ne({type:Boolean})],fe.prototype,"primary",void 0),he([ne({type:Boolean})],fe.prototype,"danger",void 0),he([ne({type:Boolean})],fe.prototype,"icon",void 0),he([ne({type:Boolean})],fe.prototype,"disabled",void 0),fe=he([ae("glk-button")],fe);var ye=t(6);var ke=new(t.n(ye).a)([{name:"home",render:()=>R`
          <glk-home></glk-home>
        `,url:"/galko"},{name:"options",render:()=>R`
          <glk-options></glk-options>
        `,title:"Options",url:"/options"},{name:"scores",render:()=>R`
          <glk-scores></glk-scores>
        `,title:"Scores",url:"/scores"},{name:"decks",render:()=>R`
          <glk-decks></glk-decks>
        `,title:"Decks",url:"/decks"},{name:"decks-builder",render:()=>R`
          <glk-decks-builder></glk-decks-builder>
        `,title:"Deck Builder",url:"/decks-builder"}],{baseUrl:"/galko",baseTitle:"Galko"}),ve=t(7),be=t.n(ve),je=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ie=class extends ue{constructor(){super(...arguments),this.href="",this.buttonise=!1}static get styles(){return ge`
      .router-link {
    ...
    `}render(){const e=`router-link${this.buttonise?" router-link--as-button":""}`,i=this.resolveLocation();return R`
      <a class="${e}" href="${i}" @click=${this.handleClick}>
        <slot></slot>
      </a>
    `}handleClick(e){if(be()(e)){const e=this.resolveLocation();ke.push(e)}}resolveLocation(){const e=this.href.startsWith(ke.base)?this.href:`${ke.base}${this.href}`;return ke.guardPath(e,!1)}};var we;je([ne({type:String})],Ie.prototype,"href",void 0),je([ne({type:Boolean})],Ie.prototype,"buttonise",void 0),Ie=je([ae("glk-router-link")],Ie),function(e){e.XXS="xxs",e.XS="xs",e.SM="sm",e.MD="md",e.LG="lg"}(we||(we={}));const Se={lg:e=>ge`
  ...
  `};function xe(e,i){switch(e){case we.LG:return Se.lg(i);case we.MD:return Se.md(i);case we.SM:return Se.sm(i);case we.XS:return Se.xs(i);case we.XXS:return Se.xxs(i)}}const _e=[{size:we.LG,num:20},{size:we.MD,num:25},{size:we.SM,num:33},{size:we.XS,num:50}].map(({size:e,num:i})=>xe(e,ge`
      .grid--standard {
        grid-template-columns: repeat(auto-fit, ${i}%);
        grid-auto-rows: 1fr;
      }
    `));var Pe,Oe=[ge`
    .grid {
  ...
  `,..._e];!function(e){e.argyle="argyle",e.blueprint="blueprint",e.chevrons="chevrons",e.honeyCombs="honeyCombs",e.shippo="shippo",e.subtleDots="subtleDots"}(Pe||(Pe={}));var Me=t(4),Ae=t.n(Me);const Ce=new Ae.a("glkOptions",{cardBack:Pe.subtleDots,deckId:"",hideOnMatch:!0,startingPairs:15}),Te=new Ae.a("glkData",{decks:[],history:[]});Te.upgrade(e=>{if(!e)return e;const i=(e.history||[]).map(e=>({...e,turns:e.turns?e.turns:0}));return{...e,history:i}});var Ne=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let $e=class extends ue{constructor(){super(...arguments),this.decks=[]}static get styles(){return[...Oe,ge`
        :host {
          margin: 10px;
        }
      ...
      `]}firstUpdated(){this.decks=Te.getKey("decks")}render(){return R`
      <section class="decks">
        <header class="header">
    ...
    `}dropDeck(e){let i=Te.getKey("decks");i=i.filter(i=>i.id!==e),Te.set({decks:i}),this.decks=i}};Ne([ne({type:Array})],$e.prototype,"decks",void 0),$e=Ne([ae("glk-decks")],$e);var Ke=t(8),Re=t.n(Ke),Be=t(2),He=t.n(Be),Ee=t(9),De=t.n(Ee);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const ze=(e,i)=>{const t=e.startNode.parentNode,s=void 0===i?e.endNode:i.startNode,a=t.insertBefore(y(),s);t.insertBefore(y(),s);const r=new x(e.options);return r.insertAfterNode(a),r},Ge=(e,i)=>(e.setValue(i),e.commit(),e),Le=(e,i,t)=>{const s=e.startNode.parentNode,a=t?t.startNode:e.endNode,r=i.endNode.nextSibling;r!==a&&o(s,i.startNode,r,a)},Ue=e=>{n(e.startNode.parentNode,e.startNode,e.endNode.nextSibling)},Fe=(e,i,t)=>{const s=new Map;for(let a=i;a<=t;a++)s.set(e[a],a);return s},Ve=new WeakMap,Ye=new WeakMap,Je=(e=>(...i)=>{const t=e(...i);return s.set(t,!0),t})((e,i,t)=>{let s;return void 0===t?t=i:void 0!==i&&(s=i),i=>{if(!(i instanceof x))throw new Error("repeat can only be used in text bindings");const a=Ve.get(i)||[],r=Ye.get(i)||[],o=[],n=[],m=[];let d,c,g=0;for(const i of e)m[g]=s?s(i,g):g,n[g]=t(i,g),g++;let l=0,u=a.length-1,p=0,h=n.length-1;for(;l<=u&&p<=h;)if(null===a[l])l++;else if(null===a[u])u--;else if(r[l]===m[p])o[p]=Ge(a[l],n[p]),l++,p++;else if(r[u]===m[h])o[h]=Ge(a[u],n[h]),u--,h--;else if(r[l]===m[h])o[h]=Ge(a[l],n[h]),Le(i,a[l],o[h+1]),l++,h--;else if(r[u]===m[p])o[p]=Ge(a[u],n[p]),Le(i,a[u],a[l]),u--,p++;else if(void 0===d&&(d=Fe(m,p,h),c=Fe(r,l,u)),d.has(r[l]))if(d.has(r[u])){const e=c.get(m[p]),t=void 0!==e?a[e]:null;if(null===t){const e=ze(i,a[l]);Ge(e,n[p]),o[p]=e}else o[p]=Ge(t,n[p]),Le(i,t,a[l]),a[e]=null;p++}else Ue(a[u]),u--;else Ue(a[l]),l++;for(;p<=h;){const e=ze(i,o[h+1]);Ge(e,n[p]),o[p++]=e}for(;l<=u;){const e=a[l++];null!==e&&Ue(e)}Ve.set(i,o),Ye.set(i,m)}});var We;!function(e){e[e.width=103]="width",e[e.height=160]="height"}(We||(We={}));var Xe=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let qe=class extends ue{constructor(){super(...arguments),this.timer=0}static get styles(){return ge``}firstUpdated(){this.image=this.images[0]}render(){return R`
      <div
        class="image"
    ...
    `}startCycler(){this.images.length<2||(clearInterval(this.timer),this.timer=window.setInterval(()=>{const e=this.images.findIndex(e=>e===this.image),i=e+1>=this.images.length?0:e+1,t=this.images[i];this.image=t},1e3))}stopCycler(){clearInterval(this.timer)}};Xe([ne({type:Array})],qe.prototype,"images",void 0),Xe([ne({type:String})],qe.prototype,"alt",void 0),Xe([ne({type:String})],qe.prototype,"image",void 0),Xe([ne({type:Number})],qe.prototype,"timer",void 0),qe=Xe([ae("glk-image-cycler")],qe);var Ze=t(1),Qe=t(10),ei=ge`
  .glk-control {
    display: flex;
...
`,ti=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};function si(e){const i=Qe.find(i=>i.id===e);return i?i.name:"(Unknown)"}let ai=class extends ue{constructor(){super(...arguments),this.noDeck=!1,this.characters=[],this.deckId="",this.deckName="",this.deckCharacterIds=[],this.search="",this.showOnlySelected=!1,this.feedback=""}static get styles(){return[ii,ei,...Oe,ge`
        .decks__title {
          font-size: 1.5rem;
          margin: 1rem 0;
        }
      ...
      `]}firstUpdated(){this.unsub=ke.subscribe(()=>this.initDeckBuilder()),this.initDeckBuilder(),this.characters=Ze.map(e=>({...e,seriesName:si(e.seriesId)}))}disconnectedCallback(){this.unsub&&this.unsub()}render(){const e=this.search.toLowerCase(),i=this.characters.filter(i=>(i.name.toLowerCase().includes(e)||i.seriesName.toLowerCase().includes(e))&&(!this.showOnlySelected||this.showOnlySelected&&this.deckCharacterIds.includes(i.id)));return this.noDeck?R`
        <div>
          <h2>We couldn't find what you were looking for.</h2>
          <div>
            <glk-router-link .href=${ke.base}
      ...
      <div class="decks">
        ...
        <div class="view">
          ...
          <ul class="grid grid--standard">
            ${Je(i,e=>e.id,e=>{const i=De()(e.name),t=[e.image,...e.images.map(e=>e.url)],s=this.deckCharacterIds.includes(e.id);return R`
                  <li
                    key=${e.id}
                    class=${pe("character-item",s&&"character-item--selected")}
                  >
                    <glk-image-cycler
                      .images=${t}
                      .alt=${e.name}
    ...
    `}initDeckBuilder(){const e=Te.getKey("decks"),i=window.location.search,t=Re()(i).deck;if(!t)return;const s=e.find(e=>e.id===t);s?(this.deckId=t,this.deckName=s.name,this.deckCharacterIds=s.characterIds):this.noDeck=!0}onToggle(e){const i=e.target;this.showOnlySelected=i.checked}onUserInput(e){const i=e.target;this[i.name]=i.value}onToggleCharacter(e){const i=new Set(this.deckCharacterIds);i.delete(e)||i.add(e),this.deckCharacterIds=Array.from(i)}dropDeck(){let e=Te.getKey("decks");e=e.filter(e=>e.id!==this.deckId),Te.set({decks:e}),ke.push("/decks")}validateForm(){const e=[];return this.deckName&&this.deckName.trim()||e.push("Deck name is required."),this.deckCharacterIds.length||e.push("Deck requires at least one character."),{success:0===e.length,errorMessages:e}}handleSave(){const e=this.validateForm();if(!e.success)return void(this.feedback=e.errorMessages.join("\n"));this.feedback="";const i=!this.deckId,t=this.deckId||He()(),s={characterIds:this.deckCharacterIds,id:t,name:this.deckName};let a=Te.getKey("decks");a=i?[...a,s]:a.map(e=>e.id===t?s:e),Te.set({decks:a}),i&&ke.push(`/decks-builder?deck=${t}`)}onDone(){ke.push("/decks")}};ti([ne({type:Boolean})],ai.prototype,"noDeck",void 0),ti([ne({type:Array})],ai.prototype,"characters",void 0),ti([ne({type:String})],ai.prototype,"deckId",void 0),ti([ne({type:String})],ai.prototype,"deckName",void 0),ti([ne({type:Array})],ai.prototype,"deckCharacterIds",void 0),ti([ne({type:String})],ai.prototype,"search",void 0),ti([ne({type:Boolean})],ai.prototype,"showOnlySelected",void 0),ti([ne({type:String})],ai.prototype,"feedback",void 0),ti([ne({type:Function})],ai.prototype,"unsub",void 0),ai=ti([ae("glk-decks-builder")],ai);var ri=ge`
  /* Shared sizing */
  :host,
  .card,
  .card__axis,
...
`,oi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let ni=class extends ue{constructor(){super(...arguments),this.image=""}static get styles(){return ge`
      :host {
        position: absolute;
        top: 0;
        left: 0;
    ...
    `}};oi([ne({type:String})],ni.prototype,"image",void 0),ni=oi([ae("glk-card-back")],ni);var mi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let di=class extends ue{constructor(){super(...arguments),this.isFaceUp=!1,this.isHidden=!1,this.shouldHide=!0,this.cardId="",this.name="",this.image="",this.width=We.width,this.height=We.height,this.cardBack=""}static get styles(){return ri}firstUpdated(){const e=Ce.get();this.shouldHide=e.hideOnMatch}render(){const e=this.isHidden&&this.shouldHide,i=this.isHidden&&!this.shouldHide;if(e)return R``;const t=this.isFaceUp||i,s=this.image?this.image.slice(0).replace(/\.jpg/,"t.jpg"):null;return R`
      <button
        type="button"
    ...
    `}handleClick(){const e=new CustomEvent("flipped",{bubbles:!0,composed:!0,detail:{cardId:this.cardId}});this.dispatchEvent(e)}};mi([ne({type:Boolean})],di.prototype,"isFaceUp",void 0),mi([ne({type:Boolean})],di.prototype,"isHidden",void 0),mi([ne({type:Boolean})],di.prototype,"shouldHide",void 0),mi([ne({type:String})],di.prototype,"cardId",void 0),mi([ne({type:String})],di.prototype,"name",void 0),mi([ne({type:String})],di.prototype,"image",void 0),mi([ne({type:Number})],di.prototype,"width",void 0),mi([ne({type:Number})],di.prototype,"height",void 0),mi([ne({type:String})],di.prototype,"cardBack",void 0),di=mi([ae("glk-card")],di);var ci=ge`
  @keyframes growth {
    0% {
      transform: scale(0);
      opacity: 0;
...
`;const gi={primaryColour:"#fdd87f",primaryColourHovered:"#999900",secondaryColour:"#51c2ea",secondaryColourHovered:"#2a87ca"};function li(e){return function(e){const i=document.createElement("div");return i.innerHTML=function(e){const{strings:i,values:t}=e,s=i.length;let a="";for(let e=0;e<s;e++)a+=i[e]+(t[e]||"");return a}(e),"data:image/svg+xml;base64,"+window.btoa(i.innerHTML)}(function(e){switch(e){case Pe.argyle:return R`
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="76">
          <g transform="scale(1 1.5)">
            <rect width="99" height="99" fill=${gi.primaryColour} />
            <rect
              width="34"
              height="34"
              transform="translate(25 0) rotate(45)"
              fill=${gi.primaryColourHovered}
            />
            <rect
              width="99"
              height="1"
              transform="rotate(45)"
              fill=${gi.secondaryColour}
            />
            <rect
              width="99"
              height="1"
      ...
      `;case Pe.shippo:return R`
        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60">
          <rect width="60" height="60" fill=${gi.primaryColour} />
          <circle cx="30" cy="30" r="30" fill=${gi.secondaryColour} />
          <path
            d="M0 30 A30 30 35 0 0 30 0 A30 30 300 0 0 60 30 A30 30 35 0 0 30 60 A30 30 250 0 0 0 30Z"
            fill=${gi.primaryColour}
          />
        </svg>
      `;case Pe.honeyCombs:return R`
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="100">
          <rect width="56" height="100" fill=${gi.primaryColour} />
          <path
            d="M28 66L0 50L0 16L28 0L56 16L56 50L28 66L28 100"
            fill="none"
            stroke=${gi.secondaryColour}
            stroke-width="2"
          />
          <path
            d="M28 0L28 34L0 50L0 84L28 100L56 84L56 50L28 34"
            fill="none"
            stroke=${gi.secondaryColourHovered}
            stroke-width="2"
          />
        </svg>
      `;case Pe.chevrons:return R`
        <svg
      ...
      `;case Pe.blueprint:return R`
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30">
          <rect width="30" height="30" fill=${gi.primaryColour} />
          <g fill=${gi.secondaryColourHovered}>
      ...
      `;case Pe.subtleDots:default:return R`
        <svg xmlns="http://www.w3.org/2000/svg" width="5" height="5">
          <rect width="5" height="5" fill=${gi.primaryColour} />
          <rect width="1" height="1" fill=${gi.secondaryColour} />
        </svg>
      `}}(e))}var ui=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let pi=class extends ue{constructor(){super(...arguments),this.cards=[],this.selected=[],this.removed=[],this.hasMatch=!1,this.cardBack=""}static get styles(){return[ge`
        :host {
          display: grid;
        ...
        ${xe(we.XXS,ge`
          ...
          `)}
      `,ci]}firstUpdated(){const e=Ce.get();this.cardBack=li(e.cardBack)}render(){const e=2===this.selected.length;return R`
      ${e?R`
            <style>
          ...
          `:""}
      ${this.cards.map(e=>{const i=this.removed.includes(e.id),t=this.selected.includes(e.id),s=[t?"glk-card--flipped":"",t&&this.hasMatch?"glk-card--matched":""].join(" ");return R`
          <glk-card
            class="${s}"
            cardId=${e.id}
            name=${e.name}
          ...
          ></glk-card>
        `})}
    `}};ui([ne({type:Array})],pi.prototype,"cards",void 0),ui([ne({type:Array})],pi.prototype,"selected",void 0),ui([ne({type:Array})],pi.prototype,"removed",void 0),ui([ne({type:Boolean})],pi.prototype,"hasMatch",void 0),ui([ne({type:String})],pi.prototype,"cardBack",void 0),pi=ui([ae("glk-card-grid")],pi);var hi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let fi=class extends ue{constructor(){super(...arguments),this.streak=0,this.uppedStreak=!1,this.timer=0}static get styles(){return ge`
      :host {
        padding: 5px;
      }
    ...
    `}updated(e){const i=e.has("streak"),t=e.get("streak")||0;i&&this.streak>t&&(this.uppedStreak=!0,this.setPulse())}render(){const e=this.streak>0,i=`${this.streak}x streak`;return R`
    ...
    `}setPulse(){clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.uppedStreak=!1},1250)}};hi([ne({type:Number})],fi.prototype,"streak",void 0),hi([ne({type:Boolean})],fi.prototype,"uppedStreak",void 0),hi([ne({type:Number})],fi.prototype,"timer",void 0),fi=hi([ae("glk-streak")],fi);var yi=t(3),ki=t.n(yi);function vi(e){const i=[e.image,...e.images.map(e=>e.url)];return ki()(i).pop()}const bi=e=>({characterId:e.id,id:He()(),image:e.image,name:e.name});var ji=t(0),Ii=t.n(ji);var wi=new class{constructor(){this.interval=0,this.paused=!0,this.gameTime=0,this.callback=()=>null}get time(){return this.formatTime(this.gameTime)}get isPaused(){return this.paused}formatTime(e){const i=Math.floor(e/60),t=e%60;return`${Ii()(i,2)}m ${Ii()(t,2)}s`}subscribe(e){return this.callback=e,this.reset(),this.start(),()=>{const e=this.gameTime;return this.callback=()=>null,this.reset(),e}}start(){this.paused=!1,clearInterval(this.interval),this.interval=window.setInterval(()=>{this.gameTime+=1,this.callback(this.time)},1e3)}stop(){this.paused=!0,clearInterval(this.interval)}reset(){this.stop(),this.gameTime=0}},Si=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};const xi=ge`
  .game-bar {
...
`;let _i=class extends ue{constructor(){super(...arguments),this.turns=[],this.timer=0,this.inGame=!1,this.timeElapsed="00m 00s",this.gameSummary=[],this.hasMatch=!1,this.pairs=[],this.choices=[],this.cards=[],this.unsubTimer=()=>0}static get styles(){return ge`
      :host {
      ...
      ${xe(we.XS,xi)}
      ${xe(we.XXS,xi)}
    `}render(){const e=this.pairs.length,i=e?e/2:0,t=this.gameSummary.length>0,s=this.getCurrentStreak(),a=e=>R`
      <div class="${e}">
    ...
    `}newGame(){this.gameSummary=[],this.turns=[],this.choices=[],this.cards=function(){const e=Te.getKey("decks"),i=Ce.get();let t=Ze;const s=e.find(e=>e.id===i.deckId);s&&(t=Ze.filter(e=>s.characterIds.includes(e.id)));const a=ki()(t).slice(0,i.startingPairs).map(e=>({...e,image:vi(e)})),r=[...a,...a];return ki()(r).map(bi)}(),this.inGame=!0,this.unsubTimer=wi.subscribe(e=>this.timeElapsed=e)}endGame(e=!1){const i=this.unsubTimer(),t=this.pairs.length/2,s=this.turns.length,a=this.getLongestStreak();if(this.inGame=!1,this.pairs=[],this.turns=[],this.choices=this.cards.map(e=>e.id),this.gameSummary=[e?"You found all the pairs!":"Quitters always quit.",`${t} pairs found in ${wi.formatTime(i)}`,`${a} was your longest match streak`],e){const e=Te.getKey("history");Te.set({history:[...e,{datetime:(new Date).getTime(),longestStreak:a,pairs:t,timeElapsed:i,turns:s}]})}}onCardFlip(e){if(2===this.choices.length)return;const i=e.detail;!this.choices.includes(i.cardId)&&(this.choices=[...this.choices,i.cardId],this.checkCards())}checkCards(){if(2!==this.choices.length)return;const e=this.choices.map(e=>{const i=this.cards.find(i=>i.id===e);if(i)return i.characterId}),i=this.turns.slice(0),t=1===new Set(e).size;this.hasMatch=t,clearTimeout(this.timer),this.timer=window.setTimeout(()=>{t&&(this.pairs=[...this.pairs,...this.choices]),this.turns=[...i,{number:i.length+1,isMatch:t}],this.choices=[],this.hasMatch=!1,this.checkGameState()},1500)}checkGameState(){this.cards.length===this.pairs.length&&0!==this.pairs.length&&this.endGame(!0)}getCurrentStreak(){return this.turns.slice(0).reverse().reduce((e,i)=>{const t=e.isBroken||!i.isMatch;return{streak:t?e.streak:e.streak+1,isBroken:t}},{streak:0,isBroken:!1}).streak}getLongestStreak(){return this.turns.slice(0).reduce((e,i)=>{const t=i.isMatch?e.streak+1:0;return{streak:t,longest:t>e.longest?t:e.longest}},{longest:0,streak:0}).longest}};Si([ne({type:Array})],_i.prototype,"turns",void 0),Si([ne({type:Number})],_i.prototype,"timer",void 0),Si([ne({type:Boolean})],_i.prototype,"inGame",void 0),Si([ne({type:String})],_i.prototype,"timeElapsed",void 0),Si([ne({type:Array})],_i.prototype,"gameSummary",void 0),Si([ne({type:Boolean})],_i.prototype,"hasMatch",void 0),Si([ne({type:Array})],_i.prototype,"pairs",void 0),Si([ne({type:Array})],_i.prototype,"choices",void 0),Si([ne({type:Array})],_i.prototype,"cards",void 0),Si([ne({type:Function})],_i.prototype,"unsubTimer",void 0),_i=Si([ae("glk-home")],_i);var Pi=t(11),Oi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};const Mi=Object.keys(Pe);let Ai=class extends ue{constructor(){super(...arguments),this.decks=[],this.startingPairs=0,this.cardBack=Pe.subtleDots,this.deckId="",this.hideOnMatch=!0}static get styles(){return[ii,ei,ge`
        :host {
          margin: 10px;
        }
      ...
      `]}firstUpdated(){const e=Ce.get();this.decks=Te.getKey("decks"),this.startingPairs=e.startingPairs,this.cardBack=e.cardBack,this.hideOnMatch=e.hideOnMatch,this.deckId=e.deckId}render(){const e=this.isValidForm(),i=e.success,t=e.messages;return R`
      <div class="options">
            ...
            >
              ${Mi.map(e=>R`
                  <option value=${e} ?selected=${e===this.cardBack}
                    >${Object(Pi.separateAndCapitalise)(e)}</option
                  >
                `)}
            </select>
          </div>
    ...
    `}onUserInput(e){const i=e.target,t=Number(i.value);this.startingPairs=t}onSelect(e){const i=e.target,t=i.name;"cardBack"===t?this.cardBack=i.value:"deckId"===t&&(this.deckId=i.value)}onToggle(e){const i=e.target;this.hideOnMatch=i.checked}isValidForm(){const e=[],i=this.startingPairs>=1&&this.startingPairs<=26;i||e.push("Starting pairs must be 1 <= n <= 26");const t=this.decks.find(e=>e.id===this.deckId),s=!t||t.characterIds.length>=this.startingPairs;return s||e.push("The deck chosen has fewer characters than the number of pairs requested."),{messages:e.join("\r\n"),success:i&&s}}handleSave(e){e.preventDefault(),this.isValidForm().success&&(Ce.set({cardBack:this.cardBack,deckId:this.deckId,hideOnMatch:this.hideOnMatch,startingPairs:this.startingPairs}),ke.push("/"))}};Oi([ne({type:Array})],Ai.prototype,"decks",void 0),Oi([ne({type:Number})],Ai.prototype,"startingPairs",void 0),Oi([ne({type:String})],Ai.prototype,"cardBack",void 0),Oi([ne({type:String})],Ai.prototype,"deckId",void 0),Oi([ne({type:Boolean})],Ai.prototype,"hideOnMatch",void 0),Ai=Oi([ae("glk-options")],Ai);var Ci=t(12),Ti=t.n(Ci),Ni=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let $i=class extends ue{constructor(){super(...arguments),this.show=!1,this.direction=0}static get styles(){return ge`
      .icon {
        display: inline-block;
        margin: 0 5px;
      }
    `}render(){if(!this.direction||!this.show)return R``;const e=1===this.direction?"▲︎":"▼︎";return R`
      <span class="icon">${e}</span>
    `}};Ni([ne({type:Boolean})],$i.prototype,"show",void 0),Ni([ne({type:Number})],$i.prototype,"direction",void 0),$i=Ni([ae("glk-sort-icon")],$i);var Ki=t(13),Ri=t.n(Ki);const Bi=new Map([["timeElapsed",{props:["timeElapsed","pairs"],orders:e=>e>0?["asc","desc"]:["desc","asc"]}],["datetime",{props:["datetime"],orders:e=>e>0?["asc"]:["desc"]}],["pairs",{props:["pairs","timeElapsed"],orders:e=>e>0?["asc","asc"]:["desc","desc"]}],["longestStreak",{props:["longestStreak","pairs","timeElapsed"],orders:e=>e>0?["asc","desc","desc"]:["desc","asc","asc"]}],["matchAttemptsRatio",{props:["matchAttemptsRatio","timeElapsed","longestStreak"],orders:e=>e>0?["asc","desc","asc"]:["desc","asc","desc"]}]]);var Hi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Ei=class extends ue{constructor(){super(...arguments),this.sortField="matchAttemptsRatio",this.sortOrder=-1,this.history=[]}static get styles(){return[ge`
        :host {
          margin: 10px;
        }
        ...
        ${xe(we.XXS,ge`
          ...
          `)}
      `]}firstUpdated(){const e=Te.getKey("history");this.history=e.map(e=>({...e,date:Ti()(e.datetime),matchAttemptsRatio:0!==e.turns?e.pairs/e.turns:0,timeElapsedDisplay:wi.formatTime(e.timeElapsed)}))}render(){const e=function(e,i,t){const s=Bi.get(i);return Ri()(e,s.props,s.orders(t))}(this.history,this.sortField,this.sortOrder);return R`
      <section class="history">
        <header class="history__header">
          <h2 class="history__title">Game history</h2>
        </header>
        <ul class="list">
          ${0===this.history.length?R`
    ...
    `}itemNumber(e){return`#${Ii()(e+1,3)}`}handleSort(e){this.sortField===e&&(this.sortOrder=1===this.sortOrder?-1:1),this.sortField=e}};Hi([ne({type:Array})],Ei.prototype,"sortField",void 0),Hi([ne({type:Array})],Ei.prototype,"sortOrder",void 0),Hi([ne({type:Array})],Ei.prototype,"history",void 0),Ei=Hi([ae("glk-scores")],Ei);var Di=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let zi=class extends ue{constructor(){super(...arguments),this.routeKey=""}firstUpdated(){ke.subscribe(({key:e})=>this.routeKey=e)}render(){let e=ke.currentRoute;return e||(e={name:"404",render:()=>R`
          <h2>We couldn't find what you were looking for.</h2>
          <div>
            <glk-router-link .href=${ke.base}
              >Return to Home</glk-router-link
        ...
        `,url:""}),e.render(this.routeKey)}};Di([ne({type:String})],zi.prototype,"routeKey",void 0),zi=Di([ae("glk-router-view")],zi);var Gi=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};let Li=class extends ue{constructor(){super(...arguments),this.text="",this.delay=750,this.allowWrapping=!1,this.usePosition=!1,this.timer=0,this.isHovered=!1,this.at=[]}static get styles(){return ge`
      .tooltip {
        position: relative;
      }
      .tooltip__content {
    ...
    `}render(){const[e,i,t]=this.at,s=t?{transform:`translateX(${t}px)`}:{},a=this.usePosition?{top:i,left:e,bottom:"unset",...s}:{...s},r=(o=a,Object.keys(o).reduce((e,i)=>`${e}${i}: ${o[i]};`,""));var o;return R`
      <div
        class=${pe("tooltip",this.isHovered&&"tooltip--hovered")}
        @mouseenter=${this.handleEnter}
        @mouseleave=${this.handleLeave}
      >
        <div
          style="${r}"
          class=${pe("tooltip__content",this.allowWrapping&&"tooltip__content--wrap",this.usePosition&&"tooltip__content--fixed")}
        >
          ${this.text}
        </div>
        <slot></slot>
      </div>
    `}handleEnter(e){const{clientX:i,clientY:t}=e,s=this.shadowRoot.querySelector(".tooltip");let a=0;if(s&&s.firstChild){const e=s.getBoundingClientRect(),i=s.firstChild.offsetWidth,t=window.innerWidth-(e.width+e.left);i>e.left+e.width/2?a=-e.left:t<i&&(a=-(i-t))}clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.isHovered=!0,this.at=[i,t,a]},this.delay)}handleLeave(){clearTimeout(this.timer),this.isHovered=!1,this.at=[]}};Gi([ne({type:String})],Li.prototype,"text",void 0),Gi([ne({type:Number})],Li.prototype,"delay",void 0),Gi([ne({type:Boolean})],Li.prototype,"allowWrapping",void 0),Gi([ne({type:Boolean})],Li.prototype,"usePosition",void 0),Gi([ne({type:Number})],Li.prototype,"timer",void 0),Gi([ne({type:Boolean})],Li.prototype,"isHovered",void 0),Gi([ne({type:Array})],Li.prototype,"at",void 0),Li=Gi([ae("glk-tooltip")],Li);var Ui=function(e,i,t,s){var a,r=arguments.length,o=r<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,t):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,i,t,s);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(o=(r<3?a(o):r>3?a(i,t,o):a(i,t))||o);return r>3&&o&&Object.defineProperty(i,t,o),o};"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/galko/sw.js").then(e=>console.log("SW registered: ",e)).catch(e=>console.log("SW registration failed: ",e))});let Fi=class extends ue{static get styles(){return ge`
      :host,
      main {
    ...
    `}render(){const e=ke.base;return R`
      <main>
